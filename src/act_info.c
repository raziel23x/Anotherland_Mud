...
{
    "#R<#L-#G(#C=#y-#0 Light  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0R Finger#y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0L Finger#y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Neck  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Neck  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Body  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Head  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Legs  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Feet  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 Hands  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Arms  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Hand  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Body  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 Waist  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 L Wrist#y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 R Wrist#y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 R Hand #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 L Hand #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 T Hand #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 F Hand #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0  Face  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0L Scabbard#y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0R Scabbard#y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0Special #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 Float  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0 Medal  #y-#C=#G)#L-#R>#n ",
    "#R<#L-#G(#C=#y-#0Bodyart #y-#C=#G)#L-#R>#n ",
};
...
char *format_obj_to_char( OBJ_DATA *obj, CHAR_DATA *ch, bool fShort )
{
    ...
    else if ( IS_SET(obj->quest, QUEST_ANLA )) strcat(buf, "#0(#rA#lL#n#0)#n ");
    ...
    if ( IS_OBJ_STAT(obj, ITEM_SHADOWPLANE) &&
        obj->in_room != NULL &&
        !IS_AFFECTED(ch,AFF_SHADOWPLANE) )    strcat( buf,"#0(Shadowplane)#n " );
    if (!IS_OBJ_STAT(obj, ITEM_SHADOWPLANE) &&
        obj->in_room != NULL &&
        IS_AFFECTED(ch,AFF_SHADOWPLANE) )    strcat( buf, "#7(Normal plane)#n " );
    if (IS_SET(obj->spectype, SITEM_EXCAVIER)) strcat(buf,"#0(#CExcavier#0)#n ");
    if (IS_SET(obj->spectype, SITEM_LIQUID_SHADOW)) strcat(buf,"#C(#0Mithril#C)#n ");
    else if (IS_SET(obj->spectype, SITEM_DIAMOND)) strcat(buf,"#0(#CDiamond#0)#n ");
    else if (IS_SET(obj->spectype, SITEM_TITANIUM)) strcat(buf,"#0(#CTitanium#0)#n ");
    else if (IS_SET(obj->spectype, SITEM_ADAMANTITE))  strcat(buf,"#0(#CAdamantite#0)#n ");
    else if (IS_SET(obj->spectype, SITEM_STEEL))  strcat(buf,"#C(Steel)#n ");
    else if (IS_SET(obj->spectype, SITEM_IRON))  strcat(buf,"#c(Iron)#n ");
    else if (IS_SET(obj->spectype, SITEM_COPPER))  strcat(buf,"#r(Copper)#n ");
    ...
    if ( fShort )
    {
        ...
        {
            sprintf(sStringTemp," #oDam:#1(#G%d#1)#n",obj->condition);
            strcat(buf,sStringTemp);
        }
    }
    else
    {
...
int char_damroll(CHAR_DATA *ch)
{
    ...
    /* if (ch->pcdata->mod_str > 0)
     {
     value += (ch->pcdata->mod_str * 10);
     }  */
    if (!IS_NPC(ch))
    {
        value += get_curr_str(ch)*10;
        value += ch->xdamroll;
    }
    ...
    if (IS_CLASS(ch, CLASS_VAMPIRE) && IS_SET(ch->polyaff, POLY_WOLF) )
        value += ch->wpn[0];
    if (IS_CLASS(ch, CLASS_PHOENIX) && ch->rage > 0)
        value += ch->rage;
    if( IS_CLASS(ch, CLASS_MONK) && IS_ITEMAFF(ch, ITEMA_CHAOSHANDS ) )
        value += 200;
    if ( IS_CLASS(ch, CLASS_MONK) )
        value += 50*ch->chi[CURRENT];
    ...
    {
        value += (ch->pcdata->classfour[DRAGON_AGE] * 100);
        value += (ch->pcdata->classfour[DRAGON_POWER] * 100);
    }
    if (IS_CLASS(ch, CLASS_ELF))
    {
        value += (ch->pcdata->classtwo[ELF_WAR_RAGE] * 125);
        value += (ch->pcdata->classtwo[ELF_WAR_FURY] * 125);
    }
    ...
    if (!IS_NPC(ch) && ch->pcdata->upgrade_level > 0)
    {
        value += ch->pcdata->upgrade_level * 200;
    }
    if (!IS_NPC(ch) && ch->pcdata->upgrade_level > 4)
    {
        value += (ch->pcdata->upgrade_level-3) * 100;
    }
    if ( IS_NPC(ch) && IS_SET(ch->act,ACT_KILLER) ) value += 2000;
...
int char_hitroll(CHAR_DATA *ch)
{
    ...
    value += ch->hitroll;
    /*  if (ch->pcdata->mod_dex > 0)
      {
       value += (ch->pcdata->mod_dex * 10);
      }   */

    if (!IS_NPC(ch))
        value += get_curr_dex(ch)*10;
...
int char_ac(CHAR_DATA *ch)
{
    ...
    value += ch->armor-( get_curr_dex(ch)*10);
    //GET_AC(ch);
    ...
    if (IS_CLASS(ch, CLASS_DRAGON) )
    {
        value -= (ch->pcdata->classfour[DRAGON_AGE] * 150);
        value -= (ch->pcdata->classfour[DRAGON_POWER] * 200);
    }
    if (IS_CLASS(ch, CLASS_VAMPIRE) && IS_SET(ch->polyaff, POLY_WOLF) )
    {
        value -= ch->wpn[0] * 3;
    ...
    if ( !IS_NPC(ch) && ch->pcdata->upgrade_level > 0)
    {
        value -= ch->pcdata->upgrade_level * 150;
    }
    if ( IS_NPC(ch) && IS_SET(ch->act,ACT_KILLER) ) value -= 2000;
...
void show_char_to_char_0( CHAR_DATA *victim, CHAR_DATA *ch )
{
    ...
    else
    {
        ...
        if ( IS_NPC(victim) && IS_SET(victim->act, ACT_QUEST) ) strcat( buf, "#0(#yQuest Mob#0)#n" );
        if ( IS_AFFECTED(victim, AFF_PASS_DOOR)  || IS_AFFECTED(victim, AFF_ETHEREAL) ) strcat( buf, "#l(Translucent)#n ");
        ...
        if (!IS_NPC(victim) && victim->desc==NULL ) strcat( buf,"#0(#7Link-Dead#0)#n ");
    }
    ...
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_WRAITH) && IS_HERO(victim) && IS_HERO(ch))
        strcat( buf, "#R(#0Wraith#R)#n " );
    ...
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_MECHA) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#y(#0[#7-=#0] #LM#lech#La #0[#7=-#0]#y)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_DROW) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#P(#0Drow#P)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_RUNEMASTER) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#L(#7Rune Master#L)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_ELF) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#L(#7Elf#L)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_WIZARD) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#P(#yW#oizard#P)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_KAHN) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#G(#yK#oa#yh#on#G)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_DRAGON) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#G(#CD#cragon#G)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_COB) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#G(#RC#rhild #Ro#rf #RB#rlood#G)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_MILITARY) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#L(#7D#0oom #GT#gooper#L)#n ");
    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_PHOENIX) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#0(#R=#0)#RP#rhoeni#Rx#0(#R=#0)#n ");

    if ( !IS_NPC(victim) && !IS_NPC(ch) && IS_CLASS(victim, CLASS_RPONLY) && IS_HERO(victim) && IS_HERO(ch))
        strcat(buf, "#G(#yR#oole #GP#glayer#G)#n ");
    ...
    if ( IS_AFFECTED(victim, AFF_FREEZING) )
    {
        if (IS_NPC(victim))
            sprintf( buf2, "\n\r...%s is covered with shards of ice!", victim->short_descr );
        else if (!IS_NPC(victim) && IS_AFFECTED(victim,AFF_POLYMORPH))
            sprintf( buf2, "\n\r...%s is covered with shards of ice!", victim->morph );
        else
            sprintf( buf2, "\n\r...%s is covered with shards of ice!", victim->name );
    }
    ...
    if ( victim->furn )
    {
        char furnbuf[MAX_STRING_LENGTH];

        if ( victim->position == POS_STANDING )
            sprintf(furnbuf," is standing in %s#n.",victim->furn->short_descr);
        else if ( victim->position == POS_SITTING )
            sprintf(furnbuf," is sitting in %s#n.",victim->furn->short_descr);
        else sprintf(furnbuf," is in %s#n.", victim->furn->short_descr);
        strcat(buf,furnbuf);
    }
...
void do_look( CHAR_DATA *ch, char *argument )
{
    ...
    if ( arg1[0] == '\0' || !str_cmp( arg1, "auto" ) || !str_cmp( arg1, "scry"))
    {
        ...
        for (door=0 ; door < 6 ; door++)
        {
            ...
            if (IS_SET(ch->in_room->exit[door]->exit_info,EX_NEWBIE_WALL))
            {
                sprintf(buf, "     You see a newbie wall blocking %s.\n\r", exitname2[door]);
                send_to_char(buf, ch);
            }
...
// Fixed up spacings and added class information - Beorn
void do_score(CHAR_DATA *ch, char *argument)
{
    ...
    sprintf(linebuf1, " %s\n\r", get_anotherland_banner("AnotherLand Score Sheet", 66));
    sprintf(linebuf2, " %s\n\r", get_anotherland_banner("", 71));

    send_to_char(linebuf1, ch);

    sprintf(buf, "  Name: #C%s#n    Hours: #C%d #n",
    ...
    if (!IS_NPC(ch)) send_to_char( "    Level: ", ch );

    if (!IS_NPC(ch) && ch->level == 1 ) send_to_char( "#CMortal#n", ch);
    else if (!IS_NPC(ch) && ch->level == 2 ) send_to_char( "#CMortal#n", ch);
    else if (!IS_NPC(ch) && ch->level == 3 ) send_to_char( "#CAvatar#n", ch);
    else if (!IS_NPC(ch) && ch->level == 7 ) send_to_char( "#CIntern#n", ch);
    else if (!IS_NPC(ch) && ch->level == 8 ) send_to_char( "#CBuilder#n", ch);
    else if (!IS_NPC(ch) && ch->level == 9 ) send_to_char( "#CQuest Maker#n", ch);
    else if (!IS_NPC(ch) && ch->level == 10) send_to_char( "#CJudge#n", ch);
    else if (!IS_NPC(ch) && ch->level == 11) send_to_char( "#CHigh Judge#n", ch);
    else if (!IS_NPC(ch) && ch->level == 12) send_to_char( "#CImplementor#n", ch);
    else if (!IS_NPC(ch) && ch->level == 13) send_to_char( "#CCreator#n", ch);
    else if (!IS_NPC(ch) && ch->level == 14) send_to_char( "#CMarried#n", ch);

    else if (!IS_NPC(ch)) send_to_char( "#CUndetermined#n", ch);

    sprintf( buf, "    Gender: #C%s#n\n\r", ch->sex == SEX_MALE ? "Male" : ch->sex == SEX_FEMALE ? "Female" : "None" );
    send_to_char(buf,ch);

    send_to_char(linebuf2, ch);

    sprintf(buf, "  Hitpoints : #C%6d#n/#C%6d#n   STR: #G%2d#n     Hitroll:  #C%d#n\n\r",
        ch->hit, ch->max_hit, get_curr_str(ch), char_hitroll(ch) );
    send_to_char(buf, ch);

    sprintf(buf, "  Movement  : #C%6d#n/#C%6d#n   DEX: #G%2d#n     Damroll : #C%d#n\n\r",
        ch->move, ch->max_move, get_curr_dex(ch), char_damroll(ch) );
    send_to_char(buf, ch);

    sprintf(buf, "  Magics    : #C%6d#n/#C%6d#n   CON: #G%2d#n     Armor   : #C%d#n\n\r",
        ch->mana, ch->max_mana, get_curr_con(ch),  char_ac(ch) );
    send_to_char(buf, ch);

    sprintf(buf, "  Primal    : #C%13d#n   WIS: #G%2d#n     Damcap  : #C%d#n\n\r",
        ch->practice, get_curr_wis(ch),  ch->damcap[0] );
    send_to_char(buf, ch);

    sprintf(buf, "  Quest pts : #y%6d#n   INT: #G%2d#n     Attacks : #C%d#n\n\r",
        ch->pcdata->quest, get_curr_int(ch), number_attacks(ch,ch));
    send_to_char(buf, ch);
    ...
    {
        sprintf( buf, "  You have obtained #C%d #nsouls, which you keep in a little jar#n\n\r", ch->pcdata->souls);
        stc(buf, ch);
    }
    if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DROW))
    {
        sprintf( buf, "#  You have #C%d#n class points stored#n\n\r", ch->pcdata->stats[DROW_POWER] );
        send_to_char( buf, ch );
        sprintf( buf, "  You have #C%d #npoints of magic resistance#n\n\r", ch->pcdata->stats[DROW_MAGIC] );
        send_to_char( buf, ch );
        if (weather_info.sunlight == SUN_DARK)
            send_to_char("  You feel strong in the night#R]\n\r", ch );
    }
    ...
    {
        sprintf( buf, "  Kahn Class Points: #C%d#n\n\r", ch->pcdata->stats[KAHN_CURRENT] );
        send_to_char( buf, ch );
    ...
    if ( !IS_NPC(ch) )
    {
        ...
        {
            sprintf(buf,"  #nYou have attained #C%d #npoints of silver tolerance\n\r",ch->siltol);
            send_to_char( buf, ch );
        }
        if ( IS_CLASS(ch,CLASS_VAMPIRE) && ch->rage > 0)
        {
            sprintf(buf,"  #nThe beast is in control of your actions:  Affects Hitroll and Damroll by #C+%d\n\r",ch->rage);
            send_to_char( buf, ch );
        }
        if ( IS_CLASS(ch, CLASS_WEREWOLF) && IS_SET(ch->special,SPC_WOLFMAN) && ch->rage > 0)
        {
            sprintf(buf,"#n  You are raging:  Affects Hitroll and Damroll by #C+%d\n\r",ch->rage);
            send_to_char( buf, ch );
        }
        if (IS_CLASS(ch, CLASS_NINJA) && ch->rage > 0)
        {
            sprintf(buf,"#n  Your michi gives you an extra #C%d#n hitroll and damroll\n\r", ch->rage);
            send_to_char(buf,ch);
        }
        if (IS_CLASS(ch, CLASS_NINJA) && ch->pcdata->powers[NPOWER_CHIKYU] >= 6
            && ch->pcdata->powers[HARA_KIRI] > 0)
        {
            sprintf(buf,"#n  You receive the power of HaraKiri for #C%d#n more ticks\n\r",ch->pcdata->powers[HARA_KIRI]);
            send_to_char(buf,ch);
        }
        if ( IS_CLASS(ch,CLASS_DRAGON) )
        {
            sprintf(buf, "#n  You are a dragon. You age affects your Hitroll and Damroll by +%d#n\n\r", ch->pcdata->classfour[DRAGON_AGE]* 50);
            send_to_char( buf, ch );
        }

        if ( !IS_CLASS(ch, CLASS_WEREWOLF) && !IS_CLASS(ch, CLASS_VAMPIRE) &&ch->rage > 0 && !IS_CLASS(ch, CLASS_NINJA))
        {
            sprintf(buf,"#n  You are in a mad frenzy, adding #C%d#n Hitroll and Damroll\n\r",ch->rage);
            stc(buf, ch);
        }

        else if ( IS_CLASS( ch, CLASS_DEMON) && ch->pcdata->stats[DEMON_POWER] > 0)
        {
            sprintf(buf,"  #nYou are wearing demonic armour:  Affects Hitroll and Damroll by #C+%d\n\r",
    ...
    sprintf(buf, "\n\r  Experience : #C%-10d#n    Stores  : #C%-4d#n    Pk Points  : #C%-4d#n\n\r",
        ch->exp, ch->pcdata->store, ch->pcdata->pkpoints);
    send_to_char(buf, ch);
    /* old way -Beorn
      sprintf(buf, "  Alignment  : #C%d#n          Paradox : #C%-4d#n    Upgrade    : #C%-2d#n\n\r",
        ch->alignment,
        ch->pcdata->mean_paradox_counter,
        ch->pcdata->upgrade_level + 1);
      send_to_char(buf, ch);
    */

    // new way, fixes up spacing by alignment specific - Beorn
    ...
    if (ch->pcdata->last_decap[0] != NULL)
    {
        sprintf(buf, "  Decap 1    : #C%s#n\n\r",  ch->pcdata->last_decap[0]);
        send_to_char(buf, ch);
    }
    else
    {
        send_to_char("  Decap 1    : #C[#r-- #R==#C<#LX#C>#R== #r--#C]#n\n\r",ch);
    }

    if (ch->pcdata->last_decap[1] != NULL)
    {
        sprintf(buf, "  Decap 2    : #C%s#n\n\r",  ch->pcdata->last_decap[1]);
        send_to_char(buf, ch);
    }
    else
    {
        send_to_char("  Decap 2    : #C[#r-- #R==#C<#LX#C>#R== #r--#C]#n\n\r",ch);
    }

    send_to_char(linebuf2, ch);

    if ( ch->pcdata->score[SCORE_TOTAL_LEVEL] >=1 )
    {
        sprintf( buf, "  Total MLevels: #C%d  #nHigh MLevel: #C%d#n \n\r",
    ...
    {
        sprintf(buf,"  Paradox Counter: #C%d#n\n\r", ch->pcdata->mean_paradox_counter);
        send_to_char(buf,ch);
    }
    ...
    sprintf(buf, "  Autosettings: %s %s %s#n\n\r",
        (IS_SET(ch->act, PLR_AUTOEXIT)) ? "#CEXIT" : "#cexit",
        (IS_SET(ch->act, PLR_AUTOLOOT)) ? "#CLOOT" : "#cloot",
        (IS_SET(ch->act, PLR_AUTOSAC )) ? "#CSACRIFICE" : "#csacrifice");
    send_to_char(buf, ch);

    sprintf(buf, "  Briefs: %s %s %s %s %s %s#n\n\r",
        (IS_SET(ch->act, PLR_BRIEF )) ? "#C1" : "#c1",
        (IS_SET(ch->act, PLR_BRIEF2)) ? "#C2" : "#c2",
        (IS_SET(ch->act, PLR_BRIEF3)) ? "#C3" : "#c3",
        (IS_SET(ch->act, PLR_BRIEF4)) ? "#C4" : "#c4",
        (IS_SET(ch->act, PLR_BRIEF5)) ? "#C5" : "#c5",
        (IS_SET(ch->act, PLR_BRIEF6)) ? "#C6" : "#c6");
    send_to_char(buf, ch);
...
void do_oldscore( CHAR_DATA *ch, char *argument )
{
    ...
    if (!IS_NPC(ch) && (IS_EXTRA(ch,EXTRA_OSWITCH) || IS_HEAD(ch,LOST_HEAD)))
        ...
        sprintf( buf,
        "#R[#7Name: #C%s %s#R] [#7Hours played: #n#C%d #R] #n",
        ch->pcdata->switchname,
        IS_NPC(ch) ? "" : ch->pcdata->title,
        (ch->played + (int) (current_time - ch->logon))/3600);
    send_to_char( buf, ch );
    if (!IS_NPC(ch)) send_to_char( "#R[#n#7Level: ", ch );

    if (!IS_NPC(ch) && ch->level == 1 ) send_to_char( "#GMortal#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 2 ) send_to_char( "#GMortal#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 3 ) send_to_char( "#CAvatar#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 7 ) send_to_char( "#LIntern#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 8 ) send_to_char( "#yBuilder#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 9 ) send_to_char( "#pHigh Builder#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 10) send_to_char( "#oQuestor#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 11) send_to_char( "#rHigh Questor#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 12) send_to_char( "#lImplementor#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 13) send_to_char( "#0Owner#R]#n\n\r", ch);
    else if (!IS_NPC(ch) && ch->level == 14) send_to_char( "#CMarried#n", ch);

    else if (!IS_NPC(ch)) send_to_char( "#sUndetermined#n\n\r", ch);

    if ( get_trust( ch ) != ch->level )
    {
        sprintf( buf, "#R[#GTrust: #C%d#R]#n",
            get_trust( ch ) );
        send_to_char( buf, ch );
    }
    sprintf( buf, "#R[#GGender: #C%s#R ]#n", ch->sex == SEX_MALE         ? "Male"        : ch->sex == SEX_FEMALE       ? "Female"      : "None" );
    send_to_char(buf,ch);
    ...
    sprintf( buf, "#R[#GUpgrade: #C%d#R]   [#GStatus: #C%d#R]   [#GGeneration: #C%d#R]#n\n\r",ch->pcdata->upgrade_level+1, ch->race, ch->generation);
    send_to_char( buf,ch );

    sprintf( buf, "#R[#7Hit:  %d#0/#C%d#n#R]#R		[#n#7Str: #C%d#R] [#n#7Int: #C%d#R]#n\n\r",ch->hit,ch->max_hit,get_curr_str(ch),get_curr_int(ch));
    send_to_char( buf, ch );
    sprintf( buf, "#R[#7Mana: %d#0/#C%d#n#R]#R		[#n#7Wis: #C%d#R] [#n#7Dex: #C%d#R]#n\n\r",ch->mana, ch->max_mana,get_curr_wis(ch),get_curr_dex(ch));
    send_to_char( buf, ch );
    sprintf( buf, "#R[#7Move: %d#0/#C%d#n#R]#R		[#n#7Con: #C%d#R]#n\n\r",       ch->move, ch->max_move, get_curr_con(ch));
    send_to_char( buf, ch );

    sprintf( buf, "#R[#GCarrying: #7%d#0/#C%d#n#R]#R		[#GWeight: #7%d#0/#C9999#n#R]\n\r",
        ch->carry_number, can_carry_n(ch), ch->carry_weight);
    send_to_char( buf, ch );

    sprintf( buf, "#R[#7Exp: #C%-9d#7 Stores: #C%-4d #7Primal: #C%d#n#R]#n", ch->exp, ch->pcdata->store, ch->practice );
    send_to_char( buf, ch );
    ...
    if (!IS_NPC(ch) && IS_CLASS( ch, CLASS_DEMON))
    {
        sprintf( buf, "#R[#nYou have #C%d#n out of #C%d #npoints of demonic power stored#R]\n\r",
            ch->pcdata->stats[DEMON_CURRENT],  ch->pcdata->stats[DEMON_TOTAL] );
        send_to_char( buf, ch );
    }
    if (!IS_NPC(ch) && (IS_CLASS( ch, CLASS_DROID)))
    ...
    if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DEMON) && ch->generation < 13)
    {
        sprintf( buf, "#R[#nYou have obtained #C%d #nsouls, which you keep in a little jar#R]\n\r", ch->pcdata->souls);
        stc(buf, ch);
    }
    if (!IS_NPC(ch) && IS_CLASS(ch, CLASS_DROW))
    {
    ...
    sprintf( buf, "#R[#n#yAutoexit: #C%s#R] [#n#yAutoloot: #C%s#R] [#n#yAutosac: #C%s#R]\n\r",
        (!IS_NPC(ch) && IS_SET(ch->act, PLR_AUTOEXIT)) ? "YES" : "NO",  (!IS_NPC(ch) && IS_SET(ch->act, PLR_AUTOLOOT)) ? "YES" : "NO",
    ...
    if ( !IS_NPC(ch) && ch->pcdata->condition[COND_DRUNK]   > 10 )
        send_to_char( "#R[#n#7You are drunk#R]\n\r",   ch );
    if ( !IS_NPC(ch) && ch->pcdata->condition[COND_THIRST] ==  0 )
        send_to_char( "#R[#n#7You are thirsty#R]\n\r", ch );
    if ( !IS_NPC(ch) && ch->pcdata->condition[COND_FULL]   ==  0 )
        send_to_char( "#R[#n#7You are hungry#R]\n\r",  ch );
    if ( !IS_NPC(ch) && ch->pcdata->stage[0] >= 100 )
        send_to_char( "#R[#n#7You are feeling extremely horny#R]\n\r",  ch );
    else if ( !IS_NPC(ch) && ch->pcdata->stage[0] >= 50 )
        send_to_char( "#R[#n#7You are feeling pretty randy#R]\n\r",  ch );
    else if ( !IS_NPC(ch) && ch->pcdata->stage[0] >= 1 )
        send_to_char( "#R[#n#7You are feeling rather kinky#R]\n\r",  ch );

    if ( !IS_NPC(ch) && ch->pcdata->stage[1] > 0 && ch->position == POS_STANDING )
    {
        send_to_char( "#R[#n#7You are having sexual intercourse#R]\n\r",  ch );
        if (!IS_NPC(ch) && (ch->pcdata->stage[2] + 25) >= ch->pcdata->stage[1])
            send_to_char( "#R[#n#sYou are on the verge of having an orgasm#R]\n\r",  ch );
    }
    else switch ( ch->position )
    {
        case POS_DEAD:
            send_to_char( "#R[#n#7You are #RD#0E#RA#0D#n!!#R]\n\r",     ch );
            break;
        case POS_MORTAL:
            send_to_char( "#R[#n#7You are #Rmortally #n#7wounded#R]\n\r",   ch );
            break;
        case POS_INCAP:
            send_to_char( "#R[#n#7You are incapacitated#R]\n\r",    ch );
            break;
        case POS_STUNNED:
            send_to_char( "#R[#n#7You are stunned#R]\n\r",      ch );
            break;
        case POS_SLEEPING:
            send_to_char( "#R[#n#7You are sleeping#R]\n\r",     ch );
            break;
        case POS_RESTING:
            send_to_char( "#R[#n#7You are resting#R]\n\r",      ch );
            break;
        case POS_MEDITATING:
            send_to_char( "#R[#n#7You are meditating#R]\n\r",   ch );
            break;
        case POS_SITTING:
            send_to_char( "#R[#n#7You are sitting#R]\n\r",      ch );
            break;
        case POS_STANDING:
            send_to_char( "#R[#n#7You are standing#R]\n\r",     ch );
            break;
        case POS_FIGHTING:
            send_to_char( "#R[#n#7You are fighting#R]\n\r",     ch );
            break;
    }

    if ( ch->level >= 0 )
    {
        sprintf( buf, "#R[#n#7AC: #C%d#R]", a_c );
        send_to_char( buf, ch );
    }

    send_to_char( "#R[#n#7Armor: ", ch );
    if ( a_c >=  101 ) send_to_char( "#PNo Armor#R]\n\r", ch );
    else if ( a_c >=   80 ) send_to_char( "#yLight#R]\n\r",   ch );
    else if ( a_c >=   60 ) send_to_char( "#LClothed#R]\n\r",  ch );
    else if ( a_c >=   40 ) send_to_char( "#CSlight#R]\n\r", ch );
    else if ( a_c >=   20 ) send_to_char( "#GSomewhat#R]\n\r", ch );
    else if ( a_c >=    0 ) send_to_char( "#RArmored#R]\n\r",          ch );
    else if ( a_c >=  -50 ) send_to_char( "#pWell#R]\n\r",     ch );
    else if ( a_c >= -100 ) send_to_char( "#lStrong#R]\n\r", ch );
    else if ( a_c >= -250 ) send_to_char( "#cHeavy#R]\n\r",  ch );
    else if ( a_c >= -500 ) send_to_char( "#gSuperb#R]\n\r", ch );
    else if ( a_c >= -749 ) send_to_char( "#rDivine#R]\n\r", ch );
    else                    send_to_char( "#0Ultimate#R]\n\r",ch );

    sprintf( buf, "#R[#n#LHitroll: #C%d #LDamroll: #C%d #LDamcap: #C%d#R] ",
        char_hitroll(ch), char_damroll(ch), ch->damcap[0]);
    stc(buf, ch);
    if ( ch->fighting != NULL ) sprintf(buf, "#R[#LNumber Attacks: #C%d#R]#n",number_attacks(ch,ch->fighting));
    else
        sprintf(buf, "#R[#LNumber Attacks: #C%d#R]#n",number_attacks(ch,ch));
    send_to_char( buf, ch );

    if ( !IS_NPC(ch) && IS_CLASS(ch,CLASS_VAMPIRE) )
    {
        sprintf( buf, "#R[#n#7Blood: #C%d#R]\n\r", ch->pcdata->condition[COND_THIRST] );
        send_to_char( buf, ch );
    ...
    if ( ch->pcdata->score[SCORE_TOTAL_LEVEL] >=1 )
    {
        sprintf( buf, "#R[#n#7Total MLevels: #C%d #7High MLevel: #C%d#R]#n ",
            ch->pcdata->score[SCORE_TOTAL_LEVEL],ch->pcdata->score[SCORE_HIGH_LEVEL] );
        send_to_char( buf, ch );
        sprintf(ss1,"#C%d#n",ch->mkill);
        sprintf(ss2,"#C%d#n",ch->mdeath);
        sprintf( buf, "#R[#n#7MKills: %s #7MDeaths: %s#R]\n\r", ss1, ss2 );
        send_to_char( buf, ch );
    }

    if ( ch->level >= 0 )
    {
        sprintf( buf, "#R[#n#7Alignment: #C%d#R] ", ch->alignment );
        send_to_char( buf, ch );
    }
    ...
    if ( !IS_NPC(ch) )
    {
        sprintf(ss1,"#C%d#n",ch->pkill);
        sprintf(ss2,"#C%d#n",ch->pdeath);
        sprintf( buf, "#R[#n#rPKills: %s #rPDeaths: %s#R] [#n#rAWins: #C%d #rALosses: #C%d#R] [#rPkill Points: #C%d#R]#n\n\r",
            ss1, ss2, ch->pcdata->awins, ch->pcdata->alosses, ch->pcdata->pkpoints );
        send_to_char( buf, ch);
        sprintf( buf, "#R[#n#RLast Two Decaps: #y>-#C%s#y-< >-#C%s#y-< #R]#n\n\r", ch->pcdata->last_decap[0], ch->pcdata->last_decap[1] );
        send_to_char( buf, ch );
    }

    if (ch->pcdata->mean_paradox_counter > 0)
    {
        sprintf(buf,"#R[#n#RParadox Counter: #C%d#n#R]#n\n\r", ch->pcdata->mean_paradox_counter);
        send_to_char(buf,ch);
    }

    if (ch->fight_timer > 0)
    {
        sprintf(buf,"#R[#n#RYou have #C%d#n #Rrounds left on your fight timer#R]#n\n\r", ch->fight_timer);
        send_to_char(buf,ch);
    }

    /*    if ( !IS_NPC(ch) )
        {
        stcf(ch,"#R[#rBloodpower: #C%d#R] #n",ch->pcdata->bloodpower[0]);
        if ( ch->pcdata->bloodpower[1] > 0 )
            stcf(ch,"#R[#rYou are in a bloodrage! #R(#C%d#R)]#n",ch->pcdata->bloodpower[1]);
        stcf(ch,"\n\r");
        }*/

    if( !IS_NPC(ch) )
    {
        sprintf( buf, "#R[#n#7Completed #C%d #n#7quests for #C%d #n#7validated points#R]#n\n\r", ch->pcdata->questsrun, ch->pcdata->questtotal );
        stc( buf, ch);
    }
    if ( !IS_NPC(ch) /*&& ch->pcdata->quest > 0*/)
    {
        if (ch->pcdata->quest == 1)
            sprintf( buf, "#R[ #COne#n #7Quest Point#R]\n\r" );
        else
            sprintf( buf, "#R[#n #C%d #n#7Quest Points#R]\n\r", ch->pcdata->quest );
        send_to_char( buf, ch );
    }
    ...
    if ( !IS_NPC(ch) )
    {
        ...
        if ( IS_CLASS(ch,CLASS_DRAGON) )
        {
            sprintf(buf, "#R[#nYou are a dragon. You age affects your Hitroll and Damroll by +%d#R]#n\n\r", ch->pcdata->classfour[DRAGON_AGE]* 50);
            send_to_char( buf, ch );
        }
...
char *  const   month_name  [] =
{
    ...
    "the Long Shadows", "the Ancient Darkness", "the Great Evil", "the Aesir",
    "the Vaenir", "the Alfen", "the Svartalfen", "Fimbulwinter", "Vinterskugge"
};
...
void do_who(CHAR_DATA *ch, char *argument)
{
    ...
    for (d = descriptor_list; d != NULL; d = d->next)
    {
        ...
        */
        ...
        /*
         * Show what sex to them. (Chrono)
         */
        if (IS_SET(gch->act, PLR_WIZINVIS)) sprintf(invis,"#L(#RI#L)#n");
        else sprintf(invis,"#L(#RN#L)#n");

        if (gch->sex == 1) sprintf(sex,"#L(#yM#L)#n");
        else if  (gch->sex == 2) sprintf(sex,"#L(#yF#L)#n");
        else sprintf(sex,"#L(#yN)#n");

        /*
         * Replaced Pkratio with status.
         */

        if (canDecap && canKillYou) sprintf(pkratio,"#R(#G%3d#R)#n",gch->race);
        else if (canKillYou)    sprintf(pkratio,"#L(#G%3d#L)#n",gch->race);
        else if (canDecap)      sprintf(pkratio,"#L(#G%3d#L)#n",gch->race);
        else sprintf(pkratio,"#L(#G%3d#L)#n",gch->race);

        /*
         * Now let's parse the title.
         */

        mightRate = gch->pkill-gch->pdeath;
        if ( mightRate == 0 && gch->pkill != 0 ) mightRate = 1;
        ...
        else
        {
            switch (gch->level )
            {
                ...
                case MAX_LEVEL - 5:
                case MAX_LEVEL - 6:
                    /*  if ( (gch->level == 14) && (gch->sex == SEX_MALE))   title = " #C[#LHusband#C]#n      ";
                      else if ( (gch->level == 14) && (gch->sex == SEX_FEMALE)) title = " #C[#RWife#C]#n      ";
                      else if ( (gch->level == 13) && (gch->sex == SEX_MALE))   title = " #C[#0Overlord#C]#n      ";
                      else if ( (gch->level == 13) && (gch->sex == SEX_FEMALE)) title = " #C[#7Mistress#C]#n      ";
                      else if ( gch->level == 13) title = " #C[#yCreator#C]#n      ";
                      else if ( gch->level == 12) title = " #C[#GCoder#C]#n        ";
                      else if ( gch->level == 11) title = " #C[#REnforcer#C]#n    ";
                      else if ( gch->level == 10) title = " #C[#cQuester#C]#n      ";
                      else if ( gch->level ==  9) title = " #C[#LHi Builder#C]#n ";
                      else if ( gch->level ==  8) title = " #C[#lBuilder#C]#n      ";
                      else title =                        " #C[#oIntern#C]#n       ";
                      break;*/
                case MAX_LEVEL - 7:
                    if (!str_cmp(gch->name, "Raziel")) title = "#C[#GD#0est#Rr#yu#Rc#0tio#Gn#C]#n";
                    else if (!str_cmp(gch->name, "Reaver"))     title = " #C[#GP#Lrick#C]#n  ";
                    else if (!str_cmp(gch->name, "Dertaherup"))  title = " #C[#RA#7s#0s#7h#0o#7l#0e#n#C]#n      ";
                    else if (!str_cmp(gch->name, "Eclipse")) title = "#C[#RI#0ntern#RB#0itch#C]#n  ";
                    else if (!str_cmp(gch->name, "Marisella"))  title = " #C[#RS#0u#Rcc#0u#Rb#0u#Rs#C]#n      ";
                    else if (!str_cmp(gch->name, "Chrono"))     title = " #C[#7P#0u#7r#0e#R-#0E#7v#0i#7l#C]#n ";
                    else if (!str_cmp(gch->name, "Ghant"))      title = " #C[#CS#0o#Cm#0e#R-#CD#0u#Cd#0e#C]#n ";
                    else if (!str_cmp(gch->name, "Silk"))       title = " #C[#RT#rh#RE #ri#RN#rs#RA#rn#RE#C]#n";
                    else if (!str_cmp(gch->name, "Hutoshi"))    title = " #C[  #CC#7o#Cd#7e#Cr  #C]#n  ";
                    else if (!str_cmp(gch->name, "Beorn"))      title = " #C[#cAesir#C]#n  ";
                    else if (!str_cmp(gch->name, "Hughes")) title = " #C[      #C]#n ";
                    else if ( (gch->level == 14) && (gch->sex == SEX_MALE))   title = " #C[#0Overlord#C]#n    ";
                    else if ( (gch->level == 14) && (gch->sex == SEX_FEMALE)) title = " #C[#7Mistress#C]#n    ";
                    else if ( gch->level == 14) title = " #C[#GOverseer#C]#n     ";
                    else if ( gch->level == 13) title = " #C[#PHi Admin#C]#n     ";
                    else if ( gch->level == 12) title = " #C[#yAdmin#C]#n        ";
                    else if ( gch->level == 11) title = " #C[#REnforcer#C]#n     ";
                    else if ( gch->level == 10) title = " #C[#LHi Builder#C]#n   ";
                    else if ( gch->level ==  9) title = " #C[#lBuilder#C]#n      ";
                    else if ( gch->level ==  8) title = " #C[#oIntern#C]#n       ";
                    else title =                        " #C[#RDefunct#C]#n      ";
                    break;
                ...
                case MAX_LEVEL - 11:
                    ...
                    else if (gch->race > 60 ) title = " #GKha Khan#n       ";
                    else if (gch->race > 55 ) title = " #CDemigod#n       ";
                    else if (gch->race > 50 ) title = " #LEmperor#n       ";
                    else if (gch->race > 40 ) title = " #yShogun#n      ";
                    else if (gch->race > 37 ) title = " #PAlmighty#n    ";
                    else if (gch->race > 35 ) title = " #oRuler#n       ";
                    else if (gch->race > 32 ) title = " #0Warlord#n     ";
                    else if (gch->race > 30 ) title = " #RTaiko#n     ";
                    else if (gch->race > 28 ) title = " #GKing#n        ";
                    else if (gch->race > 26 ) title = " #CWarrior#n      ";
                    else if (gch->race > 24 ) title = " #LBarbarian#n   ";
                    else if (gch->race > 22 ) title = " #yBaron#n       ";
                    else if (gch->race > 20 ) title = " #PConqueror#n     ";
                    else if (gch->race > 18 ) title = " #oDuke#n        ";
                    else if (gch->race > 17 ) title = " #0Rogue#n       ";
                    else if (gch->race > 15 ) title = " #RGeneral#n     ";
                    else if (gch->race > 14 ) title = " #CSergeant#n    ";
                    else if (gch->race > 13 ) title = " #LCorporal#n     ";
                    else if (gch->race > 12 ) title = " #yMaster#n      ";
                    else if (gch->race > 11 ) title = " #PGladiator#n  ";
                    else if (gch->race > 10 ) title = " #oLord#n       ";
                    else if (gch->race >  9 ) title = " #0Legendary#n   ";
                    else if (gch->race >  8 ) title = " #RHero#n        ";
                    else if (gch->race >  6 ) title = " #GSoldier#n     ";
                    else if (gch->race >  5 ) title = " #CAdventurer#n  ";
                    else if (gch->race >  4 ) title = " #LVeteran#n     ";
                    else if (gch->race >  3 ) title = " #yPrivate#n     ";
                    else if (gch->race >  2 ) title = " #PRecruit#n     ";
                    else if (gch->race >  1 ) title = " #oCadet#n       ";
                    else if (gch->race == 1 ) title = " #RBitch#n	    ";
                    else title = " #pMaggot#n     ";
                    break;
                case MAX_LEVEL - 12:
                    title = " #RMortal#n      ";
                    break;
        ...
        if (IS_CLASS(gch, CLASS_TANARRI))
                            ...
                            {strcpy(openb, "#R<<#n" ); strcpy( closeb, "#R>>#n" );}
                                ...
                                {strcpy(openb, "#G>*<#n" ); strcpy( closeb, "#G>*<#n" );}
                                    ...
                                    {strcpy(openb, "#y((#n" ); strcpy( closeb, "#y))#n" );}
                                        ...
                                        else if ( IS_CLASS(gch, CLASS_MECHA))
                                            {strcpy( openb, "#0[#7-=#0]#n"); strcpy(closeb, "#0[#7=-#0]#n" );}
                                                ...
                                                {strcpy(openb, "#p{#0-#p}#n");strcpy( closeb, "#p{#0-#p}#n");}
                                                    ...
                                                    {strcpy(openb, "#C-=#n" ); strcpy( closeb, "#C=-#n" );}
                                                        ...
                                                        else if ( IS_CLASS(gch, CLASS_SALAMANDER))
                                                            {strcpy( openb, "(>!<)"); strcpy(closeb, "(>!<)" );}
                                                            else if ( IS_CLASS(gch, CLASS_DRAGON))
                                                                {strcpy( openb, "(#c^#C!#c^#n)"); strcpy(closeb, "(#c^#C!#c^#n)" );}
                                                                else if (IS_CLASS(gch, CLASS_NINJA))
                                                                    {strcpy(openb, "#C***#n"); strcpy(closeb, "#C***#n" );}
                                                                    else if (IS_CLASS(gch, CLASS_MONK))
                                                                        {strcpy(openb, "#0.x[#n"); strcpy(closeb, "#0]x.#n");}
                                                                        else if (IS_CLASS(gch, CLASS_RUNEMASTER))
                                                                            {strcpy(openb, "#L-==#n"); strcpy(closeb, "#L==-#n");}
                                                                            else if (IS_CLASS(gch, CLASS_WIZARD))
                                                                                {strcpy(openb, "#P+#R|#P+#n"); strcpy(closeb, "#P+#R|#P+#n");}
                                                                                else if (IS_CLASS(gch, CLASS_COB))
                                                                                    {strcpy(openb, "#L}#y|#L{#n"); strcpy(closeb, "#L}#y|#L{#n");}
                                                                                    else if (IS_CLASS(gch, CLASS_MILITARY))
                                                                                        {strcpy(openb, "#0{#g|#0}#n"); strcpy(closeb, "#0{#g|#0}#n");}
                                                                                        else if (IS_CLASS(gch, CLASS_PHOENIX))
                                                                                            {strcpy(openb, "#0(#R=#0)#n"); strcpy(closeb, "#0(#R=#0)#n");}
                                                                                            else if (IS_CLASS(gch,CLASS_WRAITH))
                                                                                                {strcpy(openb, "#0<-[#n" ); strcpy(closeb, "#0]->#n" ); }

                                                                                                else if (IS_CLASS(gch, CLASS_RPONLY))
                                                                                                    {strcpy(openb, "#yR#0P#yO#n"); strcpy(closeb, "#yR#0P#yO#n");}

                                                                                                    else if (IS_CLASS(gch, CLASS_ELF))
                                                                                                        {strcpy(openb, "#y<#o-#y<<#n"); strcpy(closeb, "#y>>#o-#y>#n");}
                                                                                                        else if (IS_CLASS(gch, CLASS_KAHN))
                                                                                                            {strcpy(openb, "#c-#C(#n"); strcpy(closeb, "#C)#c-#n");}
                                                                                                            else
                                                                                                                {strcpy(openb, "#0[#n" ); strcpy( closeb, "#0]#n" );}
                                                                                                                ...
                                                                                                                if (gch->class > 0)
                                                                                                                {
                                                                                                                    if (IS_CLASS(gch, CLASS_MAGE) )
                                                                                                                    {
                                                                                                                        if (gch->generation == 1)
                                                                                                                            ...
                                                                                                                            sprintf(kav, "%s#CHarry Potter#n%s            ", openb, closeb);
                                                                                                                    }

                                                                                                                    else if( IS_CLASS(gch, CLASS_MECHA) )
                                                                                                                    {
                                                                                                                        if (gch->generation == 1)
                                                                                                                            sprintf( kav, "%s#CH#cu#Ll#lking Behem#Lo#ct#Ch#n%s",openb,closeb);
                                                                                                                        else if (gch->generation == 2)
                                                                                                                            sprintf( kav, "%s#CM#ce#Lc#lha Warr#Li#co#Cr%s   ", openb, closeb );
                                                                                                                        else if (gch->generation == 3)
                                                                                                                            sprintf( kav, "%s#CM#ce#Lc#lha Vete#Lr#ca#Cn%s   ", openb, closeb );
                                                                                                                        else if (gch->generation == 4)
                                                                                                                            sprintf( kav, "%s#CM#ce#Lc#lha Pi#Ll#co#Ct#n%s     ", openb, closeb );
                                                                                                                        else if (gch->generation == 5)
                                                                                                                            sprintf( kav, "%s#CM#ce#Lc#lha Stud#Le#cn#Ct#n%s   ", openb, closeb );
                                                                                                                        else if (gch->generation == 6)
                                                                                                                            sprintf( kav, "%s#CM#ce#Lc#lha Trai#Ln#ce#Ce#n%s   ", openb, closeb );
                                                                                                                        else
                                                                                                                            sprintf( kav, "%s#CD#ci#Ls#lgr#La#cc#Ce#n%s        ", openb, closeb );
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    else if (IS_CLASS(gch, CLASS_DROID))
                                                                                                                    {
                                                                                                                        if (gch->generation == 1)
                                                                                                                            ...
                                                                                                                            sprintf(kav,"%s#0Eight-Legged-Freak%s",closeb,closeb);
                                                                                                                    }
                                                                                                                    else if( IS_CLASS(gch, CLASS_SHAPESHIFTER) )
                                                                                                                    {
                                                                                                                        if (gch->generation == 1)
                                                                                                                    ...
                                                                                                                    else if( IS_CLASS(gch, CLASS_ANGEL) )
                                                                                                                    {
                                                                                                                        if (gch->generation == 1)
                                                                                                                            ...
                                                                                                                            sprintf( kav, "%s#7Pat Robertson#n%s          ", openb, closeb );
                                                                                                                    }
                                                                                                                    else if( IS_CLASS(gch, CLASS_UNDEAD_KNIGHT) )
                                                                                                                    {
                                                                                                                        if (gch->generation == 1)
                                                                                                                            sprintf( kav, "%s#LUndead Warlord#n%s      ", openb, closeb );
                                                                                                                        else if (gch->generation == 2)
                                                                                                                            ...
                                                                                                                            sprintf( kav, "%s#LOld Zombie#n%s          ", openb, closeb );
                                                                                                                    }
                                                                                                                    else if ( IS_CLASS(gch, CLASS_WEREWOLF))
                                                                                                                    {
                if (gch->generation == 1)
                    ...
                    sprintf( kav, "%s#LWerePoodle#n%s   ", openb, closeb );
            }
            else if ( IS_CLASS(gch, CLASS_MONK))
            {
                if (gch->generation == 1)
                    ...
                    sprintf(kav,"%s#lAdept#n%s             ", openb, closeb);
                else
                    sprintf(kav,"%s#lYMCA Student#n%s    ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_DRAGON))
            {
                if (gch->generation == 1)
                    sprintf(kav,"%s#CA#cn#Cc#ci#Ce#cn#Ct #CD#cr#Ca#cg#Co#cn#n%s", openb, closeb);
                else if (gch->generation == 2)
                    sprintf(kav,"%s#CG#cr#Ce#ca#Ct #CW#cy#Cv#ce#Cr#cn#n%s  ", openb, closeb);
                else if (gch->generation == 3)
                    sprintf(kav,"%s#CW#cy#Cv#ce#Cr#cn#n%s        ", openb, closeb);
                else if (gch->generation == 4)
                    sprintf(kav,"%s#CW#cy#Cr#cm#n%s          ", openb, closeb);
                else if (gch->generation == 5)
                    sprintf(kav,"%s#CY#co#Cu#cn#Cg D#cr#Ca#cg#Co#cn#n%s  ", openb, closeb);
                else if (gch->generation == 6)
                    sprintf(kav,"%s#CD#cr#Ca#cg#Co#cn#n%s        ", openb, closeb);
                else if (gch->generation == 7)
                    sprintf(kav,"%s#CH#ca#Ct#cc#Ch#cl#Ci#cn#Cg#n%s     ", openb, closeb);
                else
                    sprintf(kav,"%s#CD#cr#Ca#cg#Co#cn#n%s        ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_DROW))
            {
                if (gch->generation == 1)
                    ...
                    sprintf(kav,"%s#0African Elf#n%s       ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_VAMPIRE))
            {
                if (gch->generation == 1)
                    ...
                    sprintf( kav, "%s#RB#0lack and Charred#n%s       ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_TANARRI))
            {
                ...
                {
                    sprintf( kav, "%s#RWoman#n%s               ", openb, closeb );
                }
                else
                {
                    sprintf( kav, "%s#REnron Executive#n%s      ", openb, closeb );
                }
            }
            else if ( IS_CLASS(gch, CLASS_LICH))
            {
                if (gch->generation == 1)
                    ...
                    sprintf( kav, "%s#7Neurotic Skeleton#n%s ", openb, closeb );
            }
            else if ( IS_CLASS(gch, CLASS_SAMURAI) )
            {
                if (gch->generation == 1)
                    ...
                    sprintf(kav, "%s#RSamus#C-#yAran#n%s          ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_NINJA) )
            {
                if (gch->generation == 1)
                    ...
                    sprintf( kav, "%s#yCreepy Stalker#n%s    ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_DEMON) )
            {
                if (gch->generation == 1)
                    ...
                    sprintf( kav, "%s#RCongressman#n%s           ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_RPONLY) )
            {
                sprintf( kav, "%s #yU#onclassed#n%s              ", openb, closeb);
            }
            else if (IS_CLASS(gch, CLASS_MILITARY))
            {
                sprintf(kav, "%s#7D#0oom #GT#grooper#n %s     ", openb, closeb);
            }
            else if (IS_CLASS(gch, CLASS_PHOENIX))
            {
                sprintf(kav, "%s#RP#rhoeni#Rx#n%s           ", openb, closeb);
            }
            //TO BE CUSTOMIZED
            else if ( IS_CLASS(gch, CLASS_COB) )
            {
                //  if (gch->generation == 2)//{
                //if (gch->name=="Joshua")
                //  sprintf( kav, "%s#RH#rusband #RO#rf #RM#rarisella #n%s", openb, closeb);
                // else if (gch->name=="Marisella")
                //  sprintf( kav, "%s#RW#ife #RO#rf #RJ#roshua #n%s        ", openb, closeb);}

                if (gch->generation == 1)
                    sprintf( kav, "%s#RW#rife #RO#rf#R J#roshua#n%s         ", openb, closeb);
                else if (gch->generation == 2)
                    sprintf( kav, "%s#RH#rusband #RO#rf#R M#rarisella#n%s   ", openb,closeb);
                else if (gch->generation == 3)
                    sprintf( kav, "%s#RC#ronsumed#n%s            ", openb, closeb);
                else if (gch->generation == 4)
                    sprintf( kav, "%s#RM#ressenger#n%s              ", openb, closeb);
                else if (gch->generation == 5)
                    sprintf( kav, "%s#RT#rainted #RO#rne#n%s            ", openb, closeb);
                else if (gch->generation == 6)
                    sprintf( kav, "%s#RP#rossesed#n%s            ", openb, closeb);
                else if (gch->generation == 7)
                    sprintf( kav, "%s#RP#rossesed#n%s            ", openb, closeb);
                else
                    sprintf( kav, "%s#RP#rossesed#n%s            ", openb, closeb);
            ...
            {
                sprintf(kav,"%s#yK#oah#yn#n%s                ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_WRAITH) )
            {
                if (gch->generation == 1)
                    sprintf( kav, "%s#7Wraith#n%s            ", openb, closeb );
                else
                    sprintf( kav, "%s#7Spectre#n%s         ", openb, closeb );
            }
            else if ( IS_CLASS(gch, CLASS_WIZARD) )
            {
                sprintf(kav,"%s#yW#oizard#n%s            ", openb, closeb);
            }
            else if ( IS_CLASS(gch, CLASS_ELF) )
            {
                if (IS_SET(gch->special,SPC_ELF_MAGE))
                {
                    sprintf( kav, "%s #GE#gl#Gf M#ga#Gg#ge#n %s      ", openb, closeb);
                }
                else if (IS_SET(gch->special,SPC_ELF_WARRIOR))
                {
                    sprintf( kav, "%s #GE#gl#Gf W#ga#Gr#gr#Gi#go#Gr#n %s   ", openb, closeb);
                }
                else if (IS_SET(gch->special,SPC_ELF_ARCHER))
                {
                    sprintf( kav, "%s #GE#gl#Gf A#gr#Gc#gh#Ge#gr %s    ", openb, closeb);
                }
                else
                {
                    sprintf( kav, "%s #GE#gl#Gf#n %s           ", openb, closeb);
                }
            }
            else if ( IS_CLASS(gch, CLASS_RUNEMASTER) )
            {
                if ( gch->generation == 1 )
                    sprintf( kav, "%s#7Rune Master#n%s       ", openb, closeb);
                else if ( gch->generation == 2 )
                    sprintf( kav, "%s#7Rune Wizard#n%s       ", openb, closeb);
                else if ( gch->generation == 3 )
                    sprintf( kav, "%s#7Rune Forger#n%s       ", openb, closeb);
                else if ( gch->generation == 4 )
                    sprintf( kav, "%s#7Rune Mage#n%s         ", openb, closeb);
                else if ( gch->generation == 5 )
                    sprintf( kav, "%s#7Rune Apprentice#n%s   ", openb, closeb);
                else
                    sprintf( kav, "%s#7Rune Student#n%s      ", openb, closeb);
            }
            else
                sprintf( kav,   "#nSmall Weakling#n          " );
        }
        else sprintf(kav,   "#nUn-Decided....#n          " );
        ...
        if (gch->pcdata->kingdom >= 1 && gch->pcdata->kingdom <= MAX_KINGDOM)
        {
            ...
            {
                if (gch->sex == SEX_MALE) sprintf(faith, "Lr %s", kingdom_table[gch->pcdata->kingdom].whoname);
                else sprintf(faith, "Qu %s", kingdom_table[gch->pcdata->kingdom].whoname);
            }
            else if (!str_cmp(kingdom_table[gch->pcdata->kingdom].general, gch->name))
                sprintf(faith, "Gn %s", kingdom_table[gch->pcdata->kingdom].whoname);
            else
        ...
        if ( gch->pcdata->rpalign == RPALIGN_DARK )
        {
            sprintf( rp, "#0DD#n");
        }
        {
        ...
        if ( gch->pcdata->rpalign == RPALIGN_LIGHT )
        {
            sprintf( rp, "#yDD#n");
        }
        if ( gch->pcdata->rpalign == RPALIGN_LOVE )
        {
            sprintf( rp, "#RDD#n");
        }

        if ( gch->pcdata->rpalign == RPALIGN_NEUTRAL )
        {
            sprintf( rp, "#7D#0D#n");
        }
        if ( gch->pcdata->rpalign == RPALIGN_NONE )
        {
            sprintf( rp, "#n  #n");
        }

        if ( ( (gch->level > 6) && (gch->level <= ch->level) ) ||
            (gch->level > 6 && can_see(ch,gch) ) )
        {
            sprintf(buf1 + strlen(buf1), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                title2, pkratio, invis, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
            a1 = TRUE;
        }
        else if (gch->level >= 3 && gch->level <= 6)
        {
            if (gch->race > 35)
            {
                sprintf(buf2 + strlen(buf2), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a2 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 32)
            {
                sprintf(buf3 + strlen(buf3), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a3 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 30)
            {
                sprintf(buf4 + strlen(buf4), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a4 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 27)
            {
                sprintf(buf5 + strlen(buf5), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a5 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 25)
            {
                sprintf(buf6 + strlen(buf6), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a6 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 22)
            {
                sprintf(buf7 + strlen(buf7), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a7 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 20)
            {
                sprintf(buf8 + strlen(buf8), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a8 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 17)
            {
                sprintf(buf9 + strlen(buf9), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a9 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 15)
            {
                sprintf(buf10 + strlen(buf10), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a10 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 12)
            {
                sprintf(buf11 + strlen(buf11), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a11 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 10)
            {
                sprintf(buf12 + strlen(buf12), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a12 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 7)
            {
                sprintf(buf13 + strlen(buf13), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a13 = TRUE; avatars = TRUE;
            }
            else if (gch->race > 5)
            {
                sprintf(buf14 + strlen(buf14), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a14 = TRUE; avatars = TRUE;
            }
            else if (gch->race >= 1)
            {
                sprintf(buf15 + strlen(buf15), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
                a15 = TRUE; avatars = TRUE;
            }
            else
            {
                sprintf(buf16 + strlen(buf16), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                    title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
        ...
        {
            sprintf(buf17 + strlen(buf17), "%-16s %-6s %s %-17s %-2s %-8s %-8s %s\n\r",
                title2, pkratio, sex, kav, rp, gch->pcdata->switchname, gch->pcdata->title, faith);
            a17 = TRUE;
        }
    }
     ...
     */
    sprintf(buf, " %s\n\r", get_anotherland_banner("#RAnother #LLand#n", 77));
    ...
    if (a1)
    {
        ...
        {
            sprintf(buf, " %s\n\r", get_anotherland_banner("Gods", 77));
            send_to_char(buf, ch);
            send_to_char("\n\r", ch);
        }
        else
    ...
    if (avatars)
    {
        if (!IS_SET(ch->act, PLR_BRIEF))
        {
            sprintf(buf, " %s\n\r", get_anotherland_banner("Avatars", 77));
            send_to_char(buf, ch);
            send_to_char("#R Rank        Status Sex Class                    RP Name      Title      Kingdom#n\n\r",ch);
            sprintf(buf, " %s\n\r", get_anotherland_banner("", 77));
            send_to_char(buf, ch);
            send_to_char("\n\r", ch);
        }
        else
    ...
    if (a17)
    {
        if (!IS_SET(ch->act, PLR_BRIEF))
        {
            sprintf(buf, " %s\n\r", get_anotherland_banner("Mortals", 77));
            send_to_char(buf, ch);
            send_to_char("\n\r", ch);
        }
        else
    ...
    {
        sprintf(buf, "           #C%d#0/#C%d #GVisible players and #C%d #Gvisible immortal connected to %s#n\n\r", nPlayerVis, nPlayerAll, nImmVis, MUDNAME);
    }
    send_to_char(buf, ch);
    sprintf(buf,      "#0.-=+()+=-..-=+()+=-..-=+()+=-..-=+()+=-..-=+()+=-..-=+()+=-..-=+()+=-..-=+()+=-.#n\n\r");
    send_to_char(buf, ch);
...
char *PERS(CHAR_DATA *ch, CHAR_DATA *looker)
{
    ...
    {
        if (IS_IMMORTAL(ch))
            return "#7A #7M#0y#7s#0t#7i#0c#7a#0l #7B#0e#7i#0n#7g#n";
        else
            return "Someone";
    }
    return "";
...
void do_consider( CHAR_DATA *ch, char *argument )
{
    ...
    dChRounds = CalculateRaw(ch,victim);
    dVictRounds = CalculateRaw(victim,ch);
    if ( dVictRounds > dChRounds )
    {
        dDifference = dVictRounds-dChRounds;
        switch((int)dDifference)
        {
            case 0:
                stc("You two seem evenly matched, why don't you try for yourself and see?\n\r",ch);
                break;
            case 1:
                stc("You seem fairly matched up against them. You do have an advantage though.\n\r",ch);
                break;
            case 2:
                stc("You're a bit in better condition in fighting them.\n\r",ch);
                break;
            case 3:
                stc("This match won't be a very pleasant one... for them that is...\n\r",ch);
                break;
            case 4:
                stc("You might want to reconsider fighting them, it might be a waste of your time.\n\r",ch);
                break;
            case 5:
                stc("You're in much better shape then they are, you should try looking for another opponent who is more evenly matched.\n\r",ch);
                break;
            case 6:
                stc("You are in very good odds of winning against your foe.\n\r",ch);
                break;
            case 7:
                stc("This won't even be a competition...\n\r",ch);
                break;
            case 8:
                stc("Do you know the meaning of bully?\n\r",ch);
                break;
            case 9:
                stc("They won't stand a chance against you...\n\r",ch);
                break;
            default:
                stc("What type of consideration is this? It will be a complete ownage.\n\r",ch);
        }
    }
    else if ( dChRounds > dVictRounds )
    {
        dDifference = dChRounds-dVictRounds;
        switch((int)dDifference)
        {
            case 0:
                stc("You two seem evenly matched, why don't you try for yourself and see?\n\r",ch);
                break;
            case 1:
                stc("You seem fairly mathced up against them. You don't have the advantage though.\n\r",ch);
                break;
            case 2:
                stc("You're a bit worst in condition then they are.\n\r",ch);
                break;
            case 3:
                stc("You match won't be a very pleasant one for you...\n\r",ch);
                break;
            case 4:
                stc("Don't get your hopes up...\n\r",ch);
                break;
            case 5:
                stc("Living life might not be high in your priorities list if you decide to fight...\n\r",ch);
                break;
            case 6:
                stc("You seem to really like to fight things which will get you eating dirt more often then nessessary.\n\r",ch);
                break;
            case 7:
                stc("You know the meaning of being totally owned?\n\r",ch);
                break;
            case 8:
                stc("You know... you might survive, when the moon hits middle earth...\n\r",ch);
                break;
            case 9:
                stc("You would be lucky if you survived to see the lights of tomorrow.\n\r",ch);
                break;
            default:
                stc("You will have your ass, handed to you..\n\r",ch);
        }
    }
    else
        stc("You two, seem to be completely matched up against each other.\n\r",ch);
    stcf(ch,"Your raw fight data is: %f rounds to completely kill them, %f rounds to completely kill you.\n\r",dChRounds, dVictRounds);
    return;
    /*  pMight = getMight(ch);
...
void do_prefix( CHAR_DATA *ch, char *argument )
{
    ...
    {
        if ( ch->prefix ) free_string(ch->prefix);
        ch->prefix = NULL;
        stc("Prefix cleared.\n\r",ch);
        return;
    }
...
void do_title( CHAR_DATA *ch, char *argument )
{
    ...
    if ( IS_NPC(ch) )
        return;
    if ( ch->level == 7 || ch->trust == 7 )
    {
        stc("You cannot change your title, Intern.\n\r",ch);
        return;
    }
    /*    if ( ch->pcdata->quest < 5000)
        {
        send_to_char("You don't have the required 5,000 Quest Points.\n\r",ch);
        return;
        }*/
    if ( argument[0] == '\0' )
    {
...
void do_afk( CHAR_DATA *ch, char *argument )
{
    ...
    /*if ( ch->tick_timer[TIMER_NOAFK] >= 2 )
    return stcf(ch,"You can't go afk yet, play some more!\n\r"); */
    ...
    if (((ch->in_room == NULL || ch->in_room->vnum != 3054) && ch->in_room->vnum != 86000 && ch->in_room->vnum != 86010 && ch->in_room->vnum !=
        86020 && ch->in_room->vnum != 86030 && ch->in_room->vnum != 86099) && ch->level < 7)
    {
    ...
    if ( ch->tick_timer[TIMER_NOAFK] >= 2 )
    {
        stcf(ch,"You can't go afk yet, play some more!\n\r");
        return;
    }
    if (!IS_SET(ch->extra,EXTRA_AFK))
    {
        send_to_char( "You are now #rA#Rw#rA#Ry #rF#Rr#rO#Rm #rK#Re#rY#Rb#rO#Ra#rR#Rd#n!!.\n\r", ch );
        sprintf(buf,"%s is #rA#Rw#rA#Ry #rF#Rr#rO#Rm #rK#Re#rY#Rb#rO#Ra#rR#Rd#!#Y!#n",ch->name);
        do_info(ch,buf);
        SET_BIT(ch->extra,EXTRA_AFK);
        if (ch->master) stop_follower(ch);
        ch->tick_timer[TIMER_AFK] = 20;
        return;
    }
    else
        return;
    ...
    if ( argument[0] == '\0' )
    {
            ...
            for ( sn = 0; sn < MAX_SKILL; sn++ )
        {
            ...
            if ( ch->level < skill_table[sn].skill_level )
                continue;
            if (skill_table[sn].target != number) continue;
            if (number == 0) sprintf(buf, "#P%18s %d%%#n   ", skill_table[sn].name,ch->pcdata->learned[sn]);
            if (number == 1) sprintf(buf, "#R%18s %d%%#n   ", skill_table[sn].name,ch->pcdata->learned[sn]);
            if (number == 2) sprintf(buf, "#L%18s %d%%#n   ", skill_table[sn].name,ch->pcdata->learned[sn]);
            if (number == 3) sprintf(buf, "#G%18s %d%%#n   ", skill_table[sn].name,ch->pcdata->learned[sn]);
            if (number == 4) sprintf(buf, "#y%18s %d%%#n   ", skill_table[sn].name,ch->pcdata->learned[sn]);
            /*	    sprintf( buf, "%18s %3d%%  ",
...
void do_channels( CHAR_DATA *ch, char *argument )
{
    ...
    if ( arg[0] == '\0' )
    {
        ...
        send_to_char( !IS_SET(ch->deaf, CHANNEL_RPCHAT)
            ? " +RPCHAT"
            : " -RPchat",
            ch );
        ...
        send_to_char( !IS_SET(ch->deaf, CHANNEL_CHAT)
            ...
            : " -chat",
            ch );
        send_to_char( !IS_SET(ch->deaf, CHANNEL_GAME)
            ? " +GAME"
            : " -game",
            ch );
    ...
    else
    {
        ...
        else if ( !str_cmp( arg+1, "rpchat"     ) ) bit = CHANNEL_RPCHAT;
        ...
        else if ( !str_cmp( arg+1, "auctalk"   ) ) bit = CHANNEL_AUCTION;
        ...
        else if ( !str_cmp( arg+1, "game"     ) ) bit = CHANNEL_GAME;
...
void do_config( CHAR_DATA *ch, char *argument )
{
    ...
    if ( arg[0] == '\0' )
    {
        ...
        send_to_char(  IS_SET(ch->act2, PLR2_AUTOGEM)
            ? "[+AUTOGEM  ] You automatically loot gems.\n\r"
            : "[-autogem  ] You don't automatically loot gems.\n\r"
        , ch );

        send_to_char(  IS_SET(ch->act2, PLR2_AUTOHILT)
            ? "[+AUTOHILT ] You automatically loot hilts.\n\r"
            : "[-autohilt ] You don't automatically loot hilts.\n\r"
        , ch );

        send_to_char(  IS_SET(ch->act2, PLR2_AUTOSLAB)
            ? "[+AUTOSLAB ] You automatically loot slabs.\n\r"
            : "[-autoslab ] You don't automatically loot slabs.\n\r"
        , ch );
...
{
    if ( IS_NPC(ch) ) return;
    if ( IS_SET(ch->extra, EXTRA_FRYBALLS) ) return;
...
void do_autogem( CHAR_DATA *ch, char *argument )
{
    ...
    {
        REMOVE_BIT(ch->act2,PLR2_AUTOGEM);
        stc("Auto gem looting removed.\n\r",ch);
    }
    else
    {
        SET_BIT(ch->act2,PLR2_AUTOGEM);
        stc("Auto gem looting set.\n\r",ch);
    }
    return;
}
...
void do_autoslab( CHAR_DATA *ch, char *argument )
{
    ...
    {
        REMOVE_BIT(ch->act2,PLR2_AUTOSLAB);
        stc("Auto slab looting removed.\n\r",ch);
    }
    else
    {
        SET_BIT(ch->act2,PLR2_AUTOSLAB);
        stc("Auto slab looting set.\n\r",ch);
    }
    return;
}
...
void do_autohilt( CHAR_DATA *ch, char *argument )
{
    ...
    {
        REMOVE_BIT(ch->act2,PLR2_AUTOHILT);
        stc("Auto hilt looting removed.\n\r",ch);
    }
    else
    {
        SET_BIT(ch->act2,PLR2_AUTOHILT);
        stc("Auto hilt looting set.\n\r",ch);
    }
    return;
}
...
void obj_score( CHAR_DATA *ch, OBJ_DATA *obj )
{
    ...
    switch ( obj->item_type )
    {
        ...
        case ITEM_XPTOKEN:
            sprintf( buf, "Your exp value is %d.\n\r", obj->value[0] );
            send_to_char( buf, ch );
            break;

        case ITEM_STORETOKEN:
            sprintf( buf, "Your store value is %d\n\r", obj->value[1] );
            send_to_char( buf, ch );
            break;
        case ITEM_PRTOKEN:
            sprintf( buf, "Your primal value is %d.\n\r", obj->value[0] );
            send_to_char( buf, ch );
            break;
...
void do_finger( CHAR_DATA *ch, char *argument )
{
    ...
    if ( ( fp = fopen( strsave, "r" ) ) != NULL )
    {
        ...
        buf=fread_string( fp );
        if (num == SEX_MALE) send_to_char("#7Male.#n          ",ch);
        else if (num == SEX_FEMALE)
        {
            send_to_char("#7Female.#n        ",ch);
            if (IS_SET(extra, EXTRA_PREGNANT)) other_age(ch,extra,TRUE,buf);
        }
        else send_to_char("#7None.#n          ",ch);
        buf=fread_string( fp );
        ...
        {
            default:
                sprintf(buf2,"#GLevel: #7Mortal#n");
                break;
            case LEVEL_AVATAR:
                sprintf(buf2,"#GLevel: #7Avatar#n");
                break;
            case LEVEL_BUILDER:
            ...
            case LEVEL_CREATOR:
            case LEVEL_SPOUSE:
                sprintf(buf2,"#GLevel: #7God#n   ");
                break;
        }
        send_to_char(buf2,ch);
        num=fread_number( fp );
        if (num > 0) num2 = (num / 3600); else num2 = 0;
        sprintf(buf2,"                #GHours: #7%d#n\n\r",num2);
        send_to_char(buf2,ch);
        buf=fread_string( fp );
        if (strlen(buf) > 2)
        {
            if (IS_SET(extra, EXTRA_MARRIED))
                sprintf(buf2,"#GMarried to#7 %s.#n\n\r",buf);
            else
                sprintf(buf2,"#GEngaged to #7%s.#n\n\r",buf);
            send_to_char(buf2,ch);
        }
        num=fread_number( fp );
        num2=fread_number( fp );
        sprintf(buf2,"#GPlayer kills:#7 %-6d        #G Player Deaths:#7 %-6d#n\n\r",num,num2);
        send_to_char(buf2,ch);
        num=fread_number( fp );
        num2=fread_number( fp );
        sprintf(buf2,"#GArena kills: #7 %-6d        #G Arena Deaths:#7  %-6d#n\n\r",num,num2);
        send_to_char(buf2,ch);
        num=fread_number(fp);
        num2=fread_number(fp);
        sprintf(buf2,"#GMob Kills:   #7 %-6d        #G Mob Deaths:#7    %-6d#n\n\r",num,num2);
        send_to_char(buf2,ch);
        sprintf(buf2,"#GClass: ");
        send_to_char(buf2,ch);
        num=fread_number( fp );
        switch ( num )
        {
            ...
            case CLASS_MAGE:
                ...
                break;
            case CLASS_TANARRI:
                sprintf(buf2,"#7Tanar'ri     ");
                break;
            case CLASS_SHAPESHIFTER:
                sprintf(buf2,"#7Shapeshifter ");
                break;
            case CLASS_DROID:
                sprintf(buf2,"#7Spiderdroid  ");
                break;
            case CLASS_SAMURAI:
                sprintf(buf2,"#7Samurai      ");
                break;
            case CLASS_UNDEAD_KNIGHT:
                sprintf(buf2,"#7Undead Knight");
                break;
            case CLASS_ANGEL:
                sprintf(buf2,"#7Angel        ");
                break;
            ...
            case CLASS_KAHN:
                ...
                break;
            case CLASS_DRAGON:
                sprintf(buf2,"#7Dragon     ");
                break;
            case CLASS_PHOENIX:
                sprintf(buf2,"#7Phoenix    ");
                break;
        }
        send_to_char(buf2,ch);

        num=fread_number( fp );
        sprintf(buf2,"         #GStatus: #7%-3d\n\r",num);
        send_to_char(buf2,ch);
        num=fread_number( fp );
        if (num > 0)
        {
            sprintf(buf2,"#GKingdom: #7%-15s\n\r",(kingdom_table[num].name));
            send_to_char(buf2, ch);
        }
        if (num == 0)
        {
            sprintf(buf2,"#GKingdom: #7None#n\n\r");
            send_to_char(buf2, ch);
        }
        sprintf(buf2, "\n\r#0==<>==<>==<>==<>==<>==<>  #G%s  #0<>==<>==<>==<>==<>==<>==#n\n\r", MUDNAME);
        send_to_char(buf2, ch);
