...
const struct flag_type area_flags[] =
{
    ...
    {   "noplayer",     AREA_NOPLAYER,      TRUE    },
    {   "noreset",      AREA_NORESET,       TRUE    },
    {   "questok",      AREA_QUESTOK,       TRUE    },
    {   "",         0,          0   }
};
...
const struct flag_type exit_flags[] =
{
    ...
    {   "newbie_wall",      EX_NEWBIE_WALL,     TRUE    },
...
const struct flag_type room_flags[] =
{
    ...
    {   "nospell",      ROOM_NOCAST,        TRUE    },
    {   "exchange",     ROOM_EXCHA,     TRUE    },
    {   "dandd",        ROOM_DD,        TRUE    },
    {   "orgy",         ROOM_SEX,       TRUE    },
    {   "notrans",      ROOM_NOTRANS,       TRUE    },
    {   "nodecap",      ROOM_NODECAP,       TRUE    },
    {   "regenerative",     ROOM_REGENERATIVE,  TRUE    },
    {   "immsafe",      ROOM_IMMSAFE,       TRUE    },
    {   "bank",         ROOM_BANK,      TRUE    },
    {   "",         0,          0   }
};
...
const struct flag_type type_flags[] =
{
    ...
    {   "ammo",         ITEM_AMMO,      TRUE    },
    {   "xptoken",              ITEM_XPTOKEN,           TRUE    },
    {   "prtoken",              ITEM_PRTOKEN,           TRUE    },
    {   "storetoken",       ITEM_STORETOKEN,    TRUE    },
    {   "quest",        ITEM_QUEST,     TRUE    },
    {   "piece",                ITEM_PIECE,             TRUE    },
    {   "flake",                ITEM_FLAKE,             TRUE    },
    {   "teleports",            ITEM_TELEPORTS,         TRUE    },
    ...
    {   "titanium",     ITEM_TITANIUM,      TRUE    },
    {   "zirconium",              ITEM_DIAMOND,           TRUE    },
    {   "Excavier",             ITEM_EXCAVIER,          TRUE    },
    {   "mithril",              ITEM_LIQUID_SHADOW,     TRUE    },
    {   "gemstone",     ITEM_GEMSTONE,      TRUE    },
    {   "hilt",         ITEM_HILT,      TRUE    },
    {   "cookingpot",       ITEM_COOKINGPOT,    TRUE    },
    {   "bomb",         ITEM_BOMB,      TRUE    },
    {   "d&d-paper",        ITEM_DND_PAPER,     TRUE    },
    {   "rune",         ITEM_RUNE,      TRUE    },
    {   "runescroll",       ITEM_RUNESCROLL,    TRUE    },
    {   "greenelfstone",    ITEM_GREENSTONE,    TRUE    },
    {   "redelfstone",          ITEM_REDSTONE,          TRUE    },
    {   "blueelfstone",         ITEM_BLUESTONE,         TRUE    },
...
const struct flag_type extra_flags[] =
{
    ...
    {   "samaffect",        ITEM_SAMAFFECT,     TRUE    },
    {   "donated",      ITEM_DONATED,       TRUE    },
    {   "quested",      ITEM_QUESTED,       TRUE    },
    {   "noclaim",      ITEM_NOCLAIM,       TRUE    },
    {   "autoclaim",        ITEM_AUTOCLAIM,     TRUE    },
    {   "autoengrave",      ITEM_AUTOENGRAVE,   TRUE    },
    {   "",         0,          0   }
};
...
const struct flag_type act_flags[] =
{
    ...
    {   "nopent",       ACT_NOPENT,     TRUE    },
    {   "quest",        ACT_QUEST,      TRUE    },
    {   "dummy",        ACT_DUMMY,      TRUE    },
...
const struct flag_type affect_flags[] =
{
    ...
    {   "freezing",     AFF_FREEZING,       TRUE    },
    //	{   "classme",      AFF_CLASSME,        TRUE    },
    {   "",         0,          0   }
};
...
{
    {   "arm",          ITEM_ARM,       TRUE    },
    {   "no-quest",     ITEM_NO_QUEST,      TRUE    },
    {   "no-interrupt",     ITEM_NO_INTERRUPT,  TRUE    },
    {   "daemonseed",       ITEM_DAEMONSEED,    TRUE    },
    {   "juju-bag",     ITEM_JUJU_BAG,      TRUE    },
    {   "voo-head",     ITEM_VOO_HEAD,      TRUE    },
    {   "voo-dead",     ITEM_VOO_DEAD,      TRUE    },
    {   "voo-body",     ITEM_VOO_BODY,      TRUE    },
    {   "voo-thread",       ITEM_VOO_THREAD,    TRUE    },
    {   "ingred-gloin",     ITEM_INGRED_GLOIN,  TRUE    },
    {   "ingred-frogbreath",    ITEM_INGRED_FROGBREATH, TRUE    },
    {   "ingred-papacoco",  ITEM_INGRED_PAPACOCO,   TRUE    },
    {   "ingred-muldaleaf", ITEM_INGRED_MULDALEAF,  TRUE    },
    {   "ingred-scullyweed",    ITEM_INGRED_SCULLYWEED, TRUE    },
    {   "ingred-wormwart",  ITEM_INGRED_WORMWART,   TRUE    },
    {   "ingred-tillifreen",    ITEM_INGRED_TILLIFREEN, TRUE    },
    {   "ingred-bajuju",    ITEM_INGRED_BAJUJU, TRUE    },
    {   "attack-good",      ITEM_ATTACK_GOOD,   TRUE    },
    {   "itemhide",     ITEM_ITEMHIDE,      TRUE    },
    {   "ice",          ITEM_ICE,       TRUE    },
    {   "destroyed",        ITEM_DESTROYED,     TRUE    },
    {   "unique",       ITEM_UNIQUE,        TRUE    },
    {   "desired",      ITEM_DESIRED,       TRUE    },
    {   "indestructable",   ITEM_INDESTRUCTABLE,    TRUE    },
    {   "teleport-protection",  ITEM_TELEPORT_PROTECTION,TRUE   },
    {   "know-owner",       ITEM_KNOW_OWNER,    TRUE    },
    {   "flying",       ITEM_FLYING,        TRUE    },
    {   "form-melded",      ITEM_FORM_MELDED,   TRUE    },
    {   "",         0,          0   },
};
...
const struct flag_type weap_flags[] =
{
    ...
    {   "sunblade",     WEAPON_SUNBLADE,    TRUE    },
    {   "dragonlance",      WEAPON_DRAGONLANCE, TRUE    },
    {   "silver",       WEAPON_SILVER,      TRUE    },
    {   "rune-forcebolt",   WEAPON_RUNE_FORCE_BOLT, TRUE    },
    {   "rune-smiteevil",   WEAPON_RUNE_SMITE_EVIL, TRUE    },
    {   "rune-blaze",       WEAPON_RUNE_BLAZE,  TRUE    },
    {   "rune-lightning",   WEAPON_RUNE_LIGHTNING,  TRUE    },
    {   "rune-dancing",     WEAPON_RUNE_DANCING,    TRUE    },
    {   "elem-flame",       WEAPON_ELE_FLAME,   TRUE    },
    {   "elem-water",       WEAPON_ELE_WATER,   TRUE    },
    {   "elem-earth",       WEAPON_ELE_EARTH,   TRUE    },
    {   "elem-air",     WEAPON_ELE_AIR,     TRUE    },
    {   "",         0,          0   }
};

const struct flag_type quest_flags [] =
{
    {   "freename",     QUEST_FREENAME,     TRUE    },
    {   "enchanted",        QUEST_ENCHANTED,    TRUE    },
    {   "spellproof",       QUEST_SPELLPROOF,   TRUE    },
    {   "artifact",     QUEST_ARTIFACT,     TRUE    },
    {   "improved",     QUEST_IMPROVED,     TRUE    },
    {   "prize",        QUEST_PRIZE,        TRUE    },
    {   "relic",        QUEST_RELIC,        TRUE    },
    {   "blooda",       QUEST_BLOODA,       TRUE    },
    {   "cloned",       QUEST_CLONED,       TRUE    },
    {   "zombie",       QUEST_ZOMBIE,       TRUE    },
    {   "forge",        QUEST_FORGE,        TRUE    },
    {   "equest",       ITEM_EQUEST,        TRUE    },
    {   "anla",         QUEST_ANLA,     TRUE    },
    {   "",         0,          0   }
};
