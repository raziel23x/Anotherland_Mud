...
const   struct  skill_type  skill_table [MAX_SKILL] =
{
    ...
    {
        "spirit kiss",      9,
        spell_spiritkiss,   TAR_CHAR_DEFENSIVE,     POS_STANDING,
        NULL,           SLOT( 520), 15, 12,
    ...
    */
    ...
    {
        "wall of force",                8,
        spell_wall_of_force,    TAR_IGNORE, POS_STANDING,
        NULL,           SLOT(206),  1000,   24,
        "wall of force",            "!Wall!"
    },
    {
        "purple sorcery",   99,
    ...
    {
        "focus",        13,
        spell_ninja_focus,      TAR_CHAR_DEFENSIVE, POS_DEAD,
        NULL,           SLOT(0),    1500,   12,
        "focus",        "!Focus!"
    },
    ...
    {
        "infirmity",        4,
                                                            //WHO COMMENTED THESE OUT?? - DERT
        spell_infirmity,        TAR_CHAR_OFFENSIVE, POS_STANDING,
        NULL,      SLOT( 0),    5, 12,
    ...
    {
        "kinetic assault",  5,
        spell_kinetic_assault,  TAR_CHAR_OFFENSIVE, POS_STANDING,
        NULL,           SLOT( 0),   5000,   12,
        "",         "!kinetic assault!"
    },
    ...
    {
        "manasplice",       9,
        spell_manasplice,   TAR_IGNORE, POS_STANDING,
        NULL,           SLOT( 0),   20000,  18,
        "",         "!manasplice!"
    },

    {
        "focused manasplice",    9,
        spell_focused_manasplice,TAR_CHAR_OFFENSIVE, POS_STANDING,
        NULL,            SLOT( 0),   20000, 12,
        "",          "!focused manasplice!"
    },

    {
        "grand manasplice",  11,
        spell_grand_manasplice,  TAR_IGNORE, POS_STANDING,
        NULL,            SLOT( 0),   30000,24,
        "",          "!grand manasplice!"
    },

    {
        "shatter",      3,
        spell_shatter,      TAR_OBJ_INV,    POS_STANDING,
        NULL,           SLOT( 0),   100,    6,
        "",         "!shatter!"
    },
    ...
    {
        "cure inebriation", 3,
        spell_cure_inebriation, TAR_CHAR_DEFENSIVE, POS_STANDING,
        NULL,           SLOT( 0),   50, 3,
        "",         "!cure inebriation!"
    },
    ...
    {
        "inebriate",        3,
        spell_inebriate,    TAR_CHAR_OFFENSIVE, POS_STANDING,
        NULL,           SLOT( 0),   50, 3,
        "",         "!inebriate!"
    },
    ...
    /*
        {
        "earthbless",		1,
        spell_earthbless,	TAR_IGNORE,		 POS_STANDING,
        NULL,			SLOT(199),	  5,	 12,
        "",			"You feel the power of the green elfstone."
        },

        {
        "firebless",		    1,
        spell_firebless,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
        NULL,			SLOT(198),	  5,	 12,
        "",			"You feel the power of the red elfstone."
        },

        {
        "waterbless",		     1,
        spell_waterbless,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
        NULL,			SLOT(197),	  5,	 12,
        "",			"You feel the power of the blue elfstone."
        },

        {
        "firecurse",		    1,
        spell_firecurse,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
        NULL,			SLOT(196),	  5,	 12,
        "",			"You feel the power of the red elfstone."
        },
    */
    {
        ...
        &gsn_equilibrium,   SLOT(0),    100,    12,
        "equilibrium",  "You feel more oriented."
    },

    {
        "slashing claw",        99,
        spell_null,     TAR_IGNORE,     POS_STANDING,
        &gsn_clawslash,     SLOT( 0),    0, 24,
        "slashing claw",        "!Slash!"
    },
...

    {
        "hatredbreath",     99,
        spell_null,     TAR_IGNORE,     POS_STANDING,
        &gsn_hatredbreath,  SLOT( 0),    0, 24,
        "hatred breath",    "!Hatred Breath!"
    },

    {
        "hatredblast",      99,
        spell_null,     TAR_IGNORE,     POS_STANDING,
        &gsn_hatredblast,   SLOT( 0),    0, 24,
        "hatred blast",     "!Hatred Blast!"
    },

    {
        "acidbreath",       99,
        spell_null,     TAR_IGNORE,     POS_STANDING,
        &gsn_acidbreath,    SLOT( 0),    0, 24,
...

    {
        "lightningarrow",   13,
        spell_null,     TAR_IGNORE, POS_STANDING,
        &gsn_lightningarrow,    SLOT( 0),   0,  24,
...

    {
        "ancestorswill",    13,
        spell_null,     TAR_IGNORE, POS_STANDING,
        &gsn_ancestorswill, SLOT( 0),   0,  24,
        "ancestor's will",  "!Ancestor's Will!"
    },

    {
        "swordslash",       99,
        spell_null,     TAR_IGNORE, POS_STANDING,
        &gsn_swordslash,    SLOT( 0),   0,  24,
    ...
    {
        "bind",             8,
        spell_bind,     TAR_CHAR_OFFENSIVE, POS_STANDING,
        NULL,           SLOT( 0),   1000,   24,
        "bind",         "!Bind!"
    },
    ...
    {
        "chain lightning",      7,
        spell_chain_lightning,  TAR_IGNORE, POS_STANDING,
        NULL,           SLOT( 0),   1000,   24,
...

    {
        "forge",            99,
        spell_null,     TAR_IGNORE, POS_STANDING,
        &gsn_forge,     SLOT( 0),   0,  24,
        "forge",        "!forge!"
    },
    {
        "deathslash",               13,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_deathslash,            SLOT( 0),        0,     24,
        "deathslash",         "!deathslash!"
    },
    {
        "soundwave",               13,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_soundwave,            SLOT( 0),        0,     24,
        "soundwave",         "!soundwave!"
    },
};
...
struct slay_type        slay_table  [MAX_SLAY_TYPES]    =
{
    /* owner	title		char_msg	vict_msg	room_msg */
    {
        ...
        "$n dresses $N in a straight jacket and takes them to an insaneasylum!",
    },
    {
        "Kip",
        "Kip's balefire",
    ...
    },
    {
        "",
        "FART",
        "You fart in $N's face as they drop dead.",
        "$n farts in your face as you drop dead.",
        "$n farts in $N's face as they drop dead.",
    }
};
...
void do_slay( CHAR_DATA *ch, char *argument )
{
    ...
    if ( type[0] == '\0' )
    {
        act( "You brutally slay $N.",ch,NULL,victim,TO_CHAR);
        act( "$n brutally slays you.",ch,NULL,victim,TO_VICT);
        act( "$n brutally slays $N.",ch,NULL,victim,TO_NOTVICT);
        raw_kill(victim);
        return;
    }
    else
