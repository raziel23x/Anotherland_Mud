...
void do_demonarmour( CHAR_DATA *ch, char *argument )
{
    ...
    {
        if      (!str_cmp(arg,"longsword"           )) vnum = 110277;
        else if (!str_cmp(arg,"ring"                )) vnum = 110264;
        else if (!str_cmp(arg,"collar"              )) vnum = 110265;
        else if (!str_cmp(arg,"bracer"              )) vnum = 110266;
        else if (!str_cmp(arg,"plate"               )) vnum = 110267;
        else if (!str_cmp(arg,"helmet"              )) vnum = 110268;
        else if (!str_cmp(arg,"leggings"            )) vnum = 110269;
        else if (!str_cmp(arg,"boots"               )) vnum = 110270;
        else if (!str_cmp(arg,"gauntlets"           )) vnum = 110271;
        else if (!str_cmp(arg,"sleeves"             )) vnum = 110272;
        else if (!str_cmp(arg,"cape"                )) vnum = 110273;
        else if (!str_cmp(arg,"belt"                )) vnum = 110274;
        else if (!str_cmp(arg,"visor"               )) vnum = 110275;
        else if (!str_cmp(arg,"shortsword"          )) vnum = 110276;
        else
        {
            do_demonarmour(ch,"");
            return;
    ...
    {
        if (!str_cmp(arg,"ring"     ))   vnum = 33122;
...
void do_travel( CHAR_DATA *ch, char *argument )
{
    ...
    */
    ...
    {
        send_to_char( " You may not join that room.\n\r",ch );
        return;
    }

    if ( IS_SET(victim->act, ACT_DUMMY) && IS_NPC(victim))
    {
        stc( " Sorry, they dummy.\n\r",ch );
        return;
    }
