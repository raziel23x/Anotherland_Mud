...
void do_drowcreate( CHAR_DATA *ch, char *argument )
{
    ...
    {
        if      (!str_cmp(arg,"whip"                )) vnum = 110650;
        else if (!str_cmp(arg,"ring"                )) vnum = 110651;
        else if (!str_cmp(arg,"amulet"              )) vnum = 110652;
        else if (!str_cmp(arg,"bracer"              )) vnum = 110653;
        else if (!str_cmp(arg,"armor"               )) vnum = 110654;
        else if (!str_cmp(arg,"helmet"              )) vnum = 110655;
        else if (!str_cmp(arg,"leggings"            )) vnum = 110656;
        else if (!str_cmp(arg,"boots"               )) vnum = 110657;
        else if (!str_cmp(arg,"gauntlets"           )) vnum = 110658;
        else if (!str_cmp(arg,"sleeves"             )) vnum = 110659;
        else if (!str_cmp(arg,"cloak"               )) vnum = 110660;
        else if (!str_cmp(arg,"belt"                )) vnum = 110661;
        else if (!str_cmp(arg,"mask"                )) vnum = 110662;
        else if (!str_cmp(arg,"dagger"              )) vnum = 110663;
        else
        {
