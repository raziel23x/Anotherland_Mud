...
/*void do_weaponbuy( CHAR_DATA *ch, char *argument )
{
        ...
        if ( !is_number(arg))
    {
      ...
      if(ch->wpn_lvl[x] == 5)
      {
        send_to_char("You have completed your training with this weapon.\n\r", ch);
        return;
      }
      ...
      stc(buf,ch);
      if ( number_range(1,5) == 1 ) do_goto(ch,"3001");
      return;
      }
//   stc("This command is broken, report to Hutoshi.\n\r",ch);
   return;
}*/
