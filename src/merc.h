...
//typedef void DO_FUN2    args( ( CHAR_DATA *ch, char *argument, char *argument2));
...
void damage_object args( (CHAR_DATA * ch, OBJ_DATA * obj, int dam) ); 
...
#define CURRENT_REVISION       12                           // change this each time you update revision of pfiles
#define PARADOX_TICK           30
#define MAX_SKILL         257
...
#define LEVEL_MORTAL           (MAX_LEVEL - 12)
#define LEVEL_AVATAR           (MAX_LEVEL - 11)
#define LEVEL_APPRENTICE       (MAX_LEVEL - 10)
#define LEVEL_MAGE         (MAX_LEVEL - 9)
#define LEVEL_ARCHMAGE         (MAX_LEVEL - 8)
#define LEVEL_NINJA        (MAX_LEVEL - 8)
#define LEVEL_MONK         (MAX_LEVEL - 8)
#define LEVEL_BUILDER          (MAX_LEVEL - 7)
#define LEVEL_QUESTMAKER       (MAX_LEVEL - 6)
#define LEVEL_ENFORCER         (MAX_LEVEL - 5)
#define LEVEL_JUDGE        (MAX_LEVEL - 4)
#define LEVEL_HIGHJUDGE        (MAX_LEVEL - 3)
#define LEVEL_IMPLEMENTOR      (MAX_LEVEL - 2)
#define LEVEL_CREATOR          (MAX_LEVEL - 1)
#define LEVEL_SPOUSE               (MAX_LEVEL)
...
#define MOB_VNUM_PARASITE        101681
#define MOB_WALL_OF_FORCE       40
...
#define PLR_CLASSME                     32                  /*WRAITH CLASSING*/
...
#define ITEMA_RETORT        536870912
#define ITEMA_BLOCK        1073741824
#define ITEMA_STANCEA        -2147483647-1
/*#define ITEMA_BEAST        -1073741824
#define ITEMA_BEAST        -536870912
#define ITEMA_BEAST        -268435456*/

#define NO_COLOUR   ""                                      /* Blank */
#define GREY        "\033[0;1;30m"                          /* Dark Grey */
#define D_RED       "\033[0;0;31m"                          /* Dark Red */
#define L_RED       "\033[0;1;31m"                          /* Light Red */
#define D_GREEN     "\033[0;0;32m"                          /* Dark Green */
#define L_GREEN     "\033[0;1;32m"                          /* Light Green */
#define BROWN       "\033[0;0;33m"                          /* Brown */
#define YELLOW      "\033[0;1;33m"                          /* Yellow */
#define D_BLUE      "\033[0;0;34m"                          /* Dark Blue */
#define L_BLUE      "\033[0;1;34m"                          /* Light Blue */
#define MAGENTA     "\033[0;0;35m"                          /* Magenta */
#define PINK        "\033[0;1;35m"                          /* Pink */
#define D_CYAN      "\033[0;0;36m"                          /* Dark Cyan */
#define L_CYAN      "\033[0;1;36m"                          /* Light Cyan */
#define NORMAL      "\033[0;0;37m"                          /* Light Grey */
#define WHITE       "\033[0;0;38m"                          /* White */
...
#define ITEM_LIQUID_SHADOW  69
#define ITEM_SOCKET             70
#define ITEM_FLAKE          71
...
#define ITEM_QUESTED        1048576
#define ITEM_NOCLAIM            2097152
#define ITEM_AUTOCLAIM      4194304
#define ITEM_AUTOENGRAVE    8388608
#define ITEM_ENGRAVED          16777216
 ...
 */
#define PLR2_BLANK            (A)
#define PLR2_AUTOGEM              (B)
#define PLR2_AUTOHILT             (C)
#define PLR2_AUTOSLAB             (D)
...
#define JFLAG_KNOWS_FORGING       32768
...
#define EXTRA_PKABLE        2097152                         /* unused */
...
#define CHANNEL_ANGEL             (3)
#define CHANNEL_IMMTALK           (4)
#define CHANNEL_MUSIC            (5)
#define CHANNEL_RPCHAT           (6)
#define CHANNEL_YELL            (7)
#define CHANNEL_VAMPTALK        (8)
#define CHANNEL_HOWL            (9)
#define CHANNEL_LOG         (10)
#define CHANNEL_PRAY           (11)
#define CHANNEL_INFO           (12)
#define CHANNEL_FLAME          (13)
#define CHANNEL_TELL          (14)
#define CHANNEL_MAGETALK      (15)
#define CHANNEL_HIGHTALK      (16)
#define CHANNEL_NEWBIE       (17)
#define CHANNEL_SIGN         (18)
#define CHANNEL_MONK         (19)
#define CHANNEL_MIKTALK     (20)
#define CHANNEL_TELEPATH    (21)
#define CHANNEL_COMMUNICATE (22)
#define CHANNEL_KNIGHTTALK  (23)
#define CHANNEL_LICHTALK       (24)
#define CHANNEL_TANTALK        (25)
#define CHANNEL_DTALK          (26)
#define CHANNEL_ELFTALK        (27)
#define CHANNEL_GAME          (28)
#define CHANNEL_AUCTION       (29)
#define CHANNEL_SOCIAL       (30)
#define CHANNEL_GAIATALK    (31)
#define CHANNEL_MILITALK    (32)
#define CHANNEL_WIZTALK     (33)
#define CHANNEL_SCREECH     (34)
#define CHANNEL_OOC     (35)
...
extern  sh_int  gsn_deathslash;
extern  sh_int  gsn_soundwave;
...
#define IS_FS2(ch, sn)           (IS_SET((ch)->ninjacrap, (sn)))
...
#define CAN_PK(ch)      (get_trust(ch)>= 3 && get_trust(ch)<= 14)
...
#define IS_FORGED(obj)      (IS_SET(obj->spectype, SITEM_COPPER) \
    ...
    || IS_SET(obj->spectype, SITEM_LIQUID_SHADOW) )
...
/*randomeq test*/
DECLARE_DO_FUN( do_randomeq        );
DECLARE_DO_FUN( do_damtest         );
DECLARE_DO_FUN( do_averagedamtest  );
/* Chrono Stuff weee */
DECLARE_DO_FUN( do_wiznet          );

/* Phoenix */
DECLARE_DO_FUN( do_firelearn        );
DECLARE_DO_FUN( do_rebirth          );
DECLARE_DO_FUN( do_firedive         );
DECLARE_DO_FUN( do_firestrike       );
DECLARE_DO_FUN( do_flare            );
DECLARE_DO_FUN( do_flameeq          );
DECLARE_DO_FUN( do_phoenixsight     );
DECLARE_DO_FUN( do_phoenixclaws     );
DECLARE_DO_FUN( do_phoenixshift     );
DECLARE_DO_FUN( do_sunfire          );
DECLARE_DO_FUN( do_tailflare        );
DECLARE_DO_FUN( do_healingtears     );
...
//testing MILITARY
DECLARE_DO_FUN( do_steroids     );
DECLARE_DO_FUN( do_medkit       );
DECLARE_DO_FUN( do_stimpack     );
DECLARE_DO_FUN( do_nightvision  );
DECLARE_DO_FUN( do_march        );
DECLARE_DO_FUN( do_bootcamp     );
DECLARE_DO_FUN( do_muutspecial  );
DECLARE_DO_FUN( do_montset      );
// RPONLY
DECLARE_DO_FUN( do_rptoken      );
/* Mages */
...
DECLARE_DO_FUN( do_resetclassleader );
...
DECLARE_DO_FUN( do_militalk     );
DECLARE_DO_FUN( do_screech      );
...
DECLARE_DO_FUN( do_worldpk      );
DECLARE_DO_FUN( do_worldtest    );
...
DECLARE_DO_FUN( do_dfangs   );
DECLARE_DO_FUN( do_dtail    );
DECLARE_DO_FUN( do_dform    );
DECLARE_DO_FUN( do_dclaws   );
DECLARE_DO_FUN( do_dwings   );
DECLARE_DO_FUN( do_dshape   );
DECLARE_DO_FUN( do_dscales  );
DECLARE_DO_FUN( do_dshield  );
DECLARE_DO_FUN( do_dstealth );
DECLARE_DO_FUN( do_dgrasp   );
...
/* Wraith Commands - Loial */
//DECLARE_DO_FUN( do_arcanoi      ); //original AL (incomplete)wraith command - dert

/* New Wraith Commands - dert */
DECLARE_DO_FUN( do_classme      );
DECLARE_DO_FUN( do_spiritsoar   );
DECLARE_DO_FUN( do_wraitheq     );
DECLARE_DO_FUN( do_ability      );
DECLARE_DO_FUN( do_deathslash   );
DECLARE_DO_FUN( do_deathaura    );
DECLARE_DO_FUN( do_soundwave    );
DECLARE_DO_FUN( do_shadowform   );
DECLARE_DO_FUN( do_wraithform   );
DECLARE_DO_FUN( do_wraithsight  );
DECLARE_DO_FUN( do_dertslash    );
 ...
 * Defined in magic.c.
 */
DECLARE_SPELL_FUN(  wall_of_force       );
...
#endif
#define SYSDAT_FILE "../txt/system.dat"			    /* Special Settings */
...
void    echo_info   args( ( char *argument) );
void    do_questchat2   args( ( char *argument) );
/* darkheart.c */
...
void  enter_info        args (( CHAR_DATA *ch, char *str ));
...
void  forge_affect2     args (( OBJ_DATA *obj, int value ));
void  forge_affect3     args (( OBJ_DATA *obj, int value ));
...
int get_artifact_count  args( ( CHAR_DATA *ch ) );
int recursive_artifact_count    args( ( OBJ_DATA *pObj ) );
int get_item_count      args( ( CHAR_DATA *ch ) );
int     recursive_item_count        args( ( OBJ_DATA *pObj ) );
...
/* magic.c */
CHAR_DATA * RandomInRoom args( ( ROOM_INDEX_DATA * pRoom, CHAR_DATA * pExempt ) );
...
#define     AREA_NORESET   32
#define AREA_QUESTOK    64
...
CHANNEL_STORAGE old_messages[STORE_MAX+1];
