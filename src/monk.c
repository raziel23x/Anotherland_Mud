...
void do_monkarmor( CHAR_DATA *ch, char *argument )
{
    ...
    {
        if      (!str_cmp(arg,"ring"                )) vnum = 110501;
        else if (!str_cmp(arg,"collar"              )) vnum = 110502;
        else if (!str_cmp(arg,"bracer"              )) vnum = 110503;
        else if (!str_cmp(arg,"robe"                )) vnum = 110504;
        else if (!str_cmp(arg,"helmet"              )) vnum = 110505;
        else if (!str_cmp(arg,"shorts"              )) vnum = 110506;
        else if (!str_cmp(arg,"boots"               )) vnum = 110507;
        else if (!str_cmp(arg,"gloves"              )) vnum = 110508;
        else if (!str_cmp(arg,"sleeves"             )) vnum = 110509;
        else if (!str_cmp(arg,"cloak"               )) vnum = 110510;
        else if (!str_cmp(arg,"belt"                )) vnum = 110511;
        else if (!str_cmp(arg,"mask"                )) vnum = 110512;
        else
        {
            do_monkarmor(ch,"");
            return;
