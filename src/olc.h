 ...
 */
#define VERSION "OLC AL Version 1.5 Modified from Original version ILAB Online Creation [Beta 1.1]"
#define AUTHOR  "     By Jason(jdinkel@mines.colorado.edu)"
#define DATE    "     Modified December/2/2002"
#define CREDITS "     Original by Surreality(cxw197@psu.edu) and Locke(locke@lm.com) \n\rModified by: Seth - Anotherland http://www.geocities.com/another_land/com"
