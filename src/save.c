...
void save_char_obj_backup( CHAR_DATA *ch )
{
    ...
    else
    {
        ...
        if ( ch->carrying != NULL )
            fwrite_obj( ch, ch->carrying, fp, 0 );
        fprintf( fp, "#END\n" );
        if      (ch->level >= 12) sprintf(chlevel,"<Creator>");
        else if (ch->level == 11) sprintf(chlevel,"<Implementor>");
        else if (ch->level == 10) sprintf(chlevel,"<High Judge>");
        else if (ch->level == 9 ) sprintf(chlevel,"<Judge>");
        else if (ch->level == 8 ) sprintf(chlevel,"<Quest Maker>");
        else if (ch->level == 7 ) sprintf(chlevel,"<Builder>");
        else if (ch->level == 6 ) sprintf(chlevel,"<Intern>");
...
void fwrite_char( CHAR_DATA *ch, FILE *fp )
{
    ...
    fprintf( fp, "SilTol      %d\n",   ch->siltol               );
    fprintf( fp, "Souls	      %d\n",   ch->pcdata->souls        );
    // Devik's Bloodpower and Bloodrage
    //    fprintf( fp, "Bloodpower  %d %d\n", ch->pcdata->bloodpower[0], ch->pcdata->bloodpower[1] );
    /* Lala */
    ...
    fprintf( fp, "Played       %d\n",
        ch->played + (int) (current_time - ch->logon)           );
    if ( ch->in_room->vnum == 72018 || (ch->was_in_room && ch->was_in_room->vnum == 72018) )
        fprintf( fp, "Room         72001\n" );
    else fprintf( fp, "Room         %d\n",
    ...
    fprintf( fp, "WpnLvls      %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
        ch->wpn_lvl[0], ch->wpn_lvl[1], ch->wpn_lvl[2], ch->wpn_lvl[3], ch->wpn_lvl[4],
        ch->wpn_lvl[5], ch->wpn_lvl[6], ch->wpn_lvl[7], ch->wpn_lvl[8], ch->wpn_lvl[9],
        ch->wpn_lvl[10], ch->wpn_lvl[11], ch->wpn_lvl[12] );
    ...
    else
    {
        ...
        fprintf( fp, "Classone	   %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
            ch->pcdata->classone[0],
            ch->pcdata->classone[1],
            ch->pcdata->classone[2],
            ch->pcdata->classone[3],
            ch->pcdata->classone[4],
            ch->pcdata->classone[5],
            ch->pcdata->classone[6],
            ch->pcdata->classone[7],
            ch->pcdata->classone[8],
            ch->pcdata->classone[9],
            ch->pcdata->classone[10],
            ch->pcdata->classone[11],
            ch->pcdata->classone[12],
            ch->pcdata->classone[13],
            ch->pcdata->classone[14],
            ch->pcdata->classone[15],
            ch->pcdata->classone[16],
            ch->pcdata->classone[17],
            ch->pcdata->classone[18],
            ch->pcdata->classone[19] );
        fprintf( fp, "Classtwo     %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
            ch->pcdata->classtwo[0],
            ch->pcdata->classtwo[1],
            ch->pcdata->classtwo[2],
            ch->pcdata->classtwo[3],
            ch->pcdata->classtwo[4],
            ch->pcdata->classtwo[5],
            ch->pcdata->classtwo[6],
            ch->pcdata->classtwo[7],
            ch->pcdata->classtwo[8],
            ch->pcdata->classtwo[9],
            ch->pcdata->classtwo[10],
            ch->pcdata->classtwo[11],
            ch->pcdata->classtwo[12],
            ch->pcdata->classtwo[13],
            ch->pcdata->classtwo[14],
            ch->pcdata->classtwo[15],
            ch->pcdata->classtwo[16],
            ch->pcdata->classtwo[17],
            ch->pcdata->classtwo[18],
            ch->pcdata->classtwo[19] );
        fprintf( fp, "Classthree     %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
            ch->pcdata->classthree[0],
            ch->pcdata->classthree[1],
            ch->pcdata->classthree[2],
            ch->pcdata->classthree[3],
            ch->pcdata->classthree[4],
            ch->pcdata->classthree[5],
            ch->pcdata->classthree[6],
            ch->pcdata->classthree[7],
            ch->pcdata->classthree[8],
            ch->pcdata->classthree[9],
            ch->pcdata->classthree[10],
            ch->pcdata->classthree[11],
            ch->pcdata->classthree[12],
            ch->pcdata->classthree[13],
            ch->pcdata->classthree[14],
            ch->pcdata->classthree[15],
            ch->pcdata->classthree[16],
            ch->pcdata->classthree[17],
            ch->pcdata->classthree[18],
            ch->pcdata->classthree[19] );
        fprintf( fp, "Classfour     %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",
            ch->pcdata->classfour[0],
            ch->pcdata->classfour[1],
            ch->pcdata->classfour[2],
            ch->pcdata->classfour[3],
            ch->pcdata->classfour[4],
            ch->pcdata->classfour[5],
            ch->pcdata->classfour[6],
            ch->pcdata->classfour[7],
            ch->pcdata->classfour[8],
            ch->pcdata->classfour[9],
            ch->pcdata->classfour[10],
            ch->pcdata->classfour[11],
            ch->pcdata->classfour[12],
            ch->pcdata->classfour[13],
            ch->pcdata->classfour[14],
            ch->pcdata->classfour[15],
            ch->pcdata->classfour[16],
            ch->pcdata->classfour[17],
            ch->pcdata->classfour[18],
            ch->pcdata->classfour[19] );
        fprintf( fp, "Bootcamp     ");
        for ( sn = 0; sn < 6; sn++)
        {
            fprintf(fp, "%d ", ch->pcdata->Bootcamp[sn]);
        }
        fprintf(fp, "\n");
        ...
        for ( sn = 0; sn < 2; sn++)
        {
            fprintf(fp, "%d ", ch->pcdata->phoenix[sn]);
        }
...
bool load_char_short( DESCRIPTOR_DATA *d, char *name)
{
    ...
    */
    ...
    for ( sn=0 ; sn < 20 ; sn++)
        ch->pcdata->classone[sn]    = 0;

    for ( sn=0 ; sn < 20 ; sn++)
        ch->pcdata->classtwo[sn]        = 0;

    for ( sn=0 ; sn < 20 ; sn++)
        ch->pcdata->classthree[sn]      = 0;

    for ( sn=0 ; sn < 20 ; sn++)
        ch->pcdata->classfour[sn]       = 0;
...
bool load_char_obj( DESCRIPTOR_DATA *d, char *name)
{
    ...
    */
    ...
    ch->pcdata->quest                   = 0;
    ch->pcdata->kingdom     = 0;
    ch->pcdata->rpalign         = 0;                        /*RPAlign None*/
    ch->pcdata->wolf                    = 0;
    ch->pcdata->rank                    = 0;
    ch->pcdata->language[0]             = 0;
    ch->pcdata->language[1]             = 0;
    ...
    if ( ( fp = fopen( strsave, "r" ) ) != NULL )
    {
        ...
        for ( ; ; )
        {
            ...
            {
                bug( "Load_char_obj: bad section. Prolly end of pfile.", 0 );
                break;
            }
        }
        fclose( fp );
    ...
    for ( ; ; )
    {
        ...
        switch ( UPPER(word[0]) )
        {
            ...
            case 'B':
                ...
                if ( !str_cmp( word, "Bootcamp" ) )
                {
                    ch->pcdata->Bootcamp[0] = fread_number(fp);
                    ch->pcdata->Bootcamp[1] = fread_number(fp);
                    ch->pcdata->Bootcamp[2] = fread_number(fp);
                    ch->pcdata->Bootcamp[3] = fread_number(fp);
                    ch->pcdata->Bootcamp[4] = fread_number(fp);
                    ch->pcdata->Bootcamp[5] = fread_number(fp);
                    fMatch = TRUE;
                }

                if ( !str_cmp(word, "Bloodpower") )
                {
                    fMatch = TRUE;
                    /*ch->pcdata->bloodpower[0] =*/ fread_number( fp );
                    /*ch->pcdata->bloodpower[1] =*/ fread_number( fp );
                }
            ...
            case 'C':
                if ( !str_cmp( word, "Classone" ) )
                {
                    ch->pcdata->classone[0] = fread_number( fp );
                    ch->pcdata->classone[1] = fread_number( fp );
                    ch->pcdata->classone[2] = fread_number( fp );
                    ch->pcdata->classone[3] = fread_number( fp );
                    ch->pcdata->classone[4] = fread_number( fp );
                    ch->pcdata->classone[5] = fread_number( fp );
                    ch->pcdata->classone[6] = fread_number( fp );
                    ch->pcdata->classone[7] = fread_number( fp );
                    ch->pcdata->classone[8] = fread_number( fp );
                    ch->pcdata->classone[9] = fread_number( fp );
                    ch->pcdata->classone[10] = fread_number( fp );
                    ch->pcdata->classone[11] = fread_number( fp );
                    ch->pcdata->classone[12] = fread_number( fp );
                    ch->pcdata->classone[13] = fread_number( fp );
                    ch->pcdata->classone[14] = fread_number( fp );
                    ch->pcdata->classone[15] = fread_number( fp );
                    ch->pcdata->classone[16] = fread_number( fp );
                    ch->pcdata->classone[17] = fread_number( fp );
                    ch->pcdata->classone[18] = fread_number( fp );
                    ch->pcdata->classone[19] = fread_number( fp );
                    fMatch = TRUE;
                    break;
                }
                if ( !str_cmp( word, "Classtwo" ) )
                {
                    ch->pcdata->classtwo[0] = fread_number( fp );
                    ch->pcdata->classtwo[1] = fread_number( fp );
                    ch->pcdata->classtwo[2] = fread_number( fp );
                    ch->pcdata->classtwo[3] = fread_number( fp );
                    ch->pcdata->classtwo[4] = fread_number( fp );
                    ch->pcdata->classtwo[5] = fread_number( fp );
                    ch->pcdata->classtwo[6] = fread_number( fp );
                    ch->pcdata->classtwo[7] = fread_number( fp );
                    ch->pcdata->classtwo[8] = fread_number( fp );
                    ch->pcdata->classtwo[9] = fread_number( fp );
                    ch->pcdata->classtwo[10] = fread_number( fp );
                    ch->pcdata->classtwo[11] = fread_number( fp );
                    ch->pcdata->classtwo[12] = fread_number( fp );
                    ch->pcdata->classtwo[13] = fread_number( fp );
                    ch->pcdata->classtwo[14] = fread_number( fp );
                    ch->pcdata->classtwo[15] = fread_number( fp );
                    ch->pcdata->classtwo[16] = fread_number( fp );
                    ch->pcdata->classtwo[17] = fread_number( fp );
                    ch->pcdata->classtwo[18] = fread_number( fp );
                    ch->pcdata->classtwo[19] = fread_number( fp );
                    fMatch = TRUE;
                    break;
                }
                if ( !str_cmp( word, "Classthree" ) )
                {
                    ch->pcdata->classthree[0] = fread_number( fp );
                    ch->pcdata->classthree[1] = fread_number( fp );
                    ch->pcdata->classthree[2] = fread_number( fp );
                    ch->pcdata->classthree[3] = fread_number( fp );
                    ch->pcdata->classthree[4] = fread_number( fp );
                    ch->pcdata->classthree[5] = fread_number( fp );
                    ch->pcdata->classthree[6] = fread_number( fp );
                    ch->pcdata->classthree[7] = fread_number( fp );
                    ch->pcdata->classthree[8] = fread_number( fp );
                    ch->pcdata->classthree[9] = fread_number( fp );
                    ch->pcdata->classthree[10] = fread_number( fp );
                    ch->pcdata->classthree[11] = fread_number( fp );
                    ch->pcdata->classthree[12] = fread_number( fp );
                    ch->pcdata->classthree[13] = fread_number( fp );
                    ch->pcdata->classthree[14] = fread_number( fp );
                    ch->pcdata->classthree[15] = fread_number( fp );
                    ch->pcdata->classthree[16] = fread_number( fp );
                    ch->pcdata->classthree[17] = fread_number( fp );
                    ch->pcdata->classthree[18] = fread_number( fp );
                    ch->pcdata->classthree[19] = fread_number( fp );
                    fMatch = TRUE;
                    break;
                }
                if ( !str_cmp( word, "Classfour" ) )
                {
                    ch->pcdata->classfour[0] = fread_number( fp );
                    ch->pcdata->classfour[1] = fread_number( fp );
                    ch->pcdata->classfour[2] = fread_number( fp );
                    ch->pcdata->classfour[3] = fread_number( fp );
                    ch->pcdata->classfour[4] = fread_number( fp );
                    ch->pcdata->classfour[5] = fread_number( fp );
                    ch->pcdata->classfour[6] = fread_number( fp );
                    ch->pcdata->classfour[7] = fread_number( fp );
                    ch->pcdata->classfour[8] = fread_number( fp );
                    ch->pcdata->classfour[9] = fread_number( fp );
                    ch->pcdata->classfour[10] = fread_number( fp );
                    ch->pcdata->classfour[11] = fread_number( fp );
                    ch->pcdata->classfour[12] = fread_number( fp );
                    ch->pcdata->classfour[13] = fread_number( fp );
                    ch->pcdata->classfour[14] = fread_number( fp );
                    ch->pcdata->classfour[15] = fread_number( fp );
                    ch->pcdata->classfour[16] = fread_number( fp );
                    ch->pcdata->classfour[17] = fread_number( fp );
                    ch->pcdata->classfour[18] = fread_number( fp );
                    ch->pcdata->classfour[19] = fread_number( fp );
                    fMatch = TRUE;
                    break;
                }
            ...
            case 'D':
                ...
                if ( !str_cmp( word, "Disc" ) )
                {
                    ...
                    break;
                                                            ...
                                                            /* Drow */
                KEY( "Drowaff",     dummy,  fread_number( fp ) );
                                                            /* Drow */
                KEY( "Drowpwr",     dummy,  fread_number( fp ) );
                                                            /* Drow */
                KEY( "Drowmag",     dummy,  fread_number( fp ) );
                break;
            ...
            case 'K':
                ...
                KEY("Kdecaptimer", ch->pcdata->kdecap_timer, fread_number(fp));
                break;
            ...
            case 'P':
                ...
                if ( !str_cmp( word, "Phoenix" ) )
                {
                    ch->pcdata->phoenix[0] = fread_number(fp);
                    ch->pcdata->phoenix[1] = fread_number(fp);
                    fMatch = TRUE;
                    break;
                }

                KEY( "Pkpoints",    ch->pcdata->pkpoints,   fread_number( fp ) );
                //KEY( "Pkpoints",	ch->pcdata->pkpoints,   fread_number( fp ) );
                KEY( "Played",      ch->played,             fread_number( fp ) );
                KEY( "Polyaff",     ch->polyaff,            fread_number( fp ) );
                                                            /* drow */
                KEY( "Power_Point", dummy,  fread_number( fp ) );
            ...
            case 'R':
                ...
                KEY( "Rpalign",    ch->pcdata->rpalign,       fread_number( fp ) );
            ...
            case 'S':
                ...
                KEY( "Store",   ch->pcdata->store,  fread_number( fp ));
                break;
            ...
            case 'W':
                ...
                if ( !str_cmp( word, "WpnLvls" ) )
                {
                    ch->wpn_lvl[0]      = fread_number( fp );
                    ch->wpn_lvl[1]      = fread_number( fp );
                    ch->wpn_lvl[2]      = fread_number( fp );
                    ch->wpn_lvl[3]      = fread_number( fp );
                    ch->wpn_lvl[4]      = fread_number( fp );
                    ch->wpn_lvl[5]      = fread_number( fp );
                    ch->wpn_lvl[6]      = fread_number( fp );
                    ch->wpn_lvl[7]      = fread_number( fp );
                    ch->wpn_lvl[8]      = fread_number( fp );
                    ch->wpn_lvl[9]      = fread_number( fp );
                    ch->wpn_lvl[10]     = fread_number( fp );
                    ch->wpn_lvl[11]     = fread_number( fp );
                    ch->wpn_lvl[12]     = fread_number( fp );
                    fMatch = TRUE;
                    break;
                }
