...
void do_taneq(CHAR_DATA *ch, char *argument)
{
    ...
    {
        if      (!str_cmp(arg,"claymore"            )) vnum = 110400;
        else if (!str_cmp(arg,"ring"                )) vnum = 110401;
        else if (!str_cmp(arg,"collar"              )) vnum = 110402;
        else if (!str_cmp(arg,"bracer"              )) vnum = 110403;
        else if (!str_cmp(arg,"plate"               )) vnum = 110404;
        else if (!str_cmp(arg,"helmet"              )) vnum = 110405;
        else if (!str_cmp(arg,"leggings"            )) vnum = 110406;
        else if (!str_cmp(arg,"boots"               )) vnum = 110407;
        else if (!str_cmp(arg,"gauntlets"           )) vnum = 110408;
        else if (!str_cmp(arg,"sleeves"             )) vnum = 110409;
        else if (!str_cmp(arg,"cloak"               )) vnum = 110410;
        else if (!str_cmp(arg,"belt"                )) vnum = 110411;
        else if (!str_cmp(arg,"visor"               )) vnum = 110412;
        else
        {
            do_taneq(ch,"");
            return;
...
void do_enmity(CHAR_DATA *ch, char *argument)
{
    ...
    if((get_age(ch) - 17) < 5)
    {
        send_to_char("You are still in newbie hours.\n\r", ch);
        return;
    }
...
void do_enrage(CHAR_DATA *ch, char *argument)               /* fuck this shit, learn to actually pk bitches */
{
    char arg[MAX_INPUT_LENGTH];
    //  char buf[100];
    CHAR_DATA *victim;
    ...
    if ((get_age(ch) - 17) < 5)
    {
        send_to_char("You're still in newbie hours.\n\r", ch);
        return;
    }
